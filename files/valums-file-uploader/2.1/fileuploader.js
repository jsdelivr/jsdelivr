...
define("fileupload", [], function () {
    ...
    qq.FileUploaderBasic.prototype = {
        ...
        _validateFile: function (file) {
            ...
            } else if (!this._options.allowEptyFiles && size === 0) {
        ...
        _formatSize: function (bytes) {
            ...
            return bytes.toFixed(1) + ['kB', 'MB', 'GB', 'TB', 'PB', 'EB'][i];
        }
    };

/*! instantsearch-googlemaps 1.0.2 | © Algolia | github.com/instantsearch/instantsearch-googlemaps */(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("React"), require("ReactDOM"));
	else if(typeof define === 'function' && define.amd)
		define(["React", "ReactDOM"], factory);
	else if(typeof exports === 'object')
		exports["instantsearchGoogleMaps"] = factory(require("React"), require("ReactDOM"));
	else
		root["instantsearchGoogleMaps"] = factory(root["React"], root["ReactDOM"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GoogleMaps = (function (_React$Component) {
	  ...
	  function GoogleMaps(props) {
	    ...
	    this._handleZoomChanged = (0, _lodashFunctionDebounce2['default'])(this._handleZoomChanged, 200);
	    this._handleDragEnd = (0, _lodashFunctionDebounce2['default'])(this._handleDragEnd, 200);
	  }
	  ...
	  _createClass(GoogleMaps, [{
	    ...
	    value: function _fitMapToMarkers(props) {
	      var bounds = new google.maps.LatLngBounds();
	      props.markers.forEach(function (_ref) {

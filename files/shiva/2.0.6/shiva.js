    ...
    var Container = (function (_super) {
            ...
            if (config) {
                ...
                if (config.styles) {
                    ...
                    styles.map(function (style) {
                        shiva.Properties.style(_this._element, style);
                    });
                }
                shiva.Properties.style(this._element, config.style);
                if (config.className) {
        ...
        Container.prototype.to = function (config) {
            ...
            setTimeout(function () {
                ...
                shiva.Properties.style(_this._element, {
                ...
                shiva.Properties.style(_this._element, config.toVars);
            }, delay);
            if (config.resolve) {
                setTimeout(function () {
                    shiva.Properties.style(_this._element, {
        ...
        Container.prototype.fromTo = function (config) {
            ...
            if (config.delay) {
                ...
                if (config.immediateRender) {
                    shiva.Properties.style(this._element, config.fromVars);
                }
            }
            else {
                shiva.Properties.style(this._element, config.fromVars);
            ...
            return new Promise(function (resolve, reject) {
                setTimeout(function () {
                    shiva.Properties.style(_this._element, config.fromVars);
                    setTimeout(function () {
                        _this.to({
...
(function (shiva) {
    var Button = (function (_super) {
        ...
        function Button(config) {
            ...
            _super.prototype.style.call(this, this.styles);
        }
        ...
        Button.prototype.style = function (_style) {
            this.styles = shiva.ObjectUtils.merge(this.styles, _style);
            _super.prototype.style.call(this, _style);
        };
...
(function (shiva) {
    var DropDown = (function (_super) {
        ...
        DropDown.prototype.itemClicked = function (e) {
            ...
            this.dispatchEvent(new shiva.Event(DropDown.CHANGE, this, element.data));
            this.unorderedList.style({
                opacity: "1"
            });

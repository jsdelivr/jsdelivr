// Loader.js
// Customized version of YepNope 1.5.4pre
//
// by
...
( function ( window, doc, undef ) {
    ...
    function injectJs ( src, cb, attrs, timeout, /* internal use */ err, internal ) {
        ...
        timeout = timeout || Loader['errorTimeout'];
    ...
    function executeStack ( ) {
        ...
        if ( i ) {
            ...
            if ( i['t'] ) {
                ...
                sTimeout( function () {
                    (i['t'] == "c" ?  Loader['injectCss'] : Loader['injectJs'])( i['s'], 0, i['a'], i['x'], i['e'], 1 );
                }, 0 );
            }
    ...
    // return the Loader object with a fresh loader attached
    function getLoader () {
        var y = Loader;
        y['loader'] = {
            "load": load,
    ...
    Loader = function ( needs ) {
        ...
        function loadScriptOrStyle ( input, callback, chain, index, testResult ) {
            ...
            if ( resource['instead'] ) {
                ...
                if ( isFunction( callback ) || isFunction( autoCallback ) ) {
                    ...
                    chain['load']( function () {
                        // Hijack Loader and restart index counter
                        getLoader();
        ...
        function loadFromTestObject ( testObject, chain ) {
            ...
            group      = testResult ? testObject['success'] : testObject['failure'],
    ...
    Loader['addPrefix'] = function ( prefix, callback ) {
        prefixes[ prefix ] = callback;
    };

    // A filter is a global function that every resource
    // object that passes through Loader will see. You can
    ...
    // supported filter
    Loader['addFilter'] = function ( filter ) {
        globalFilters.push( filter );
    };

    // Default error timeout to 10sec - modify to alter
    Loader['errorTimeout'] = 1e4;

    // Webreflection readystate hack
    // safe for jQuery 1.4+ ( i.e. don't use Loader with jQuery 1.3.2 )
    ...
    window['Loader']['executeStack'] = executeStack;
    window['Loader']['injectJs'] = injectJs;
    window['Loader']['injectCss'] = injectCss;

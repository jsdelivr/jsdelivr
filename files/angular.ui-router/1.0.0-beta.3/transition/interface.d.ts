...
export declare type IErrorHandler = (error: Error) => void;
export declare type IHookGetter = (hookName: string) => IEventHook[];
...
export declare type HookFn = (TransitionHookFn | TransitionStateHookFn);
/**
...
export declare type IStateMatch = Predicate<State>;
/**

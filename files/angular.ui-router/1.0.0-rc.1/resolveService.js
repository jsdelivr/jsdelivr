...
var $resolve = {
    ...
    * ### Not bundled by default
    ...
    resolve: function (invocables, locals, parent) {
        ...
        var parentNode = new uiRouterCore.PathNode(new uiRouterCore.State({ params: {}, resolvables: [] }));
        var node = new uiRouterCore.PathNode(new uiRouterCore.State({ params: {}, resolvables: [] }));

...
this.evercookie_cache = function(name, value)
{
	if (typeof(value) != "undefined")
	{
		...
		img.src = 'wp-content/plugins/evercookie/core/evercookie_cache.php?name=' + name;
	}
	else
	{
		...
		jQuery.ajax({
			url: document.URL + 'wp-content/plugins/evercookie/core/evercookie_cache.php?name=' + name,
...
this.evercookie_etag = function(name, value)
{
	if (typeof(value) != "undefined")
	{
		...
		img.style.visibility = 'hidden';
		img.style.position = 'absolute';
		img.src = 'wp-content/plugins/evercookie/core/evercookie_etag.php?name=' + name;
	}
	else
	{
		// interestingly enough, we want to erase our evercookie
		...
		jQuery.ajax({
			url: document.URL + 'wp-content/plugins/evercookie/core/evercookie_etag.php?name=' + name,
			success: function(data) {
				// put our cookie back
...
this.evercookie_lso = function(name, value)
{
	...
	swfobject.embedSWF(document.URL + "wp-content/plugins/evercookie/core/evercookie.swf", "swfcontainer", "1", "1", "9.0.0", false, flashvars, params, attributes);
}
...
this.evercookie_png = function(name, value)
{
	if (document.createElement('canvas').getContext)
	{
		...
		if (typeof(value) != "undefined")
		{
			...
			img.src = 'wp-content/plugins/evercookie/core/evercookie_png.php?name=' + name;
		}
		else
		{
...
this.evercookie_silverlight = function(name, value) {
    ...
    */
        var source = document.URL + "wp-content/plugins/evercookie/core/evercookie.xap";

...
(function (_root) {
    ...
    Dummy = {
        ...
        indexElements: function indexElements() {
            ...
            var textTags = document.querySelectorAll('div, p, span, h1, h2, h3, li');
        ...
        dummy: function dummy() {
            ...
            for (var i = 0; i < dummyTextFillTags.length; i++) {
                ...
                if (dummyConfig.length > 2) {
                    ...
                    for (var _i = 2; _i < dummyConfig.length; _i++) {

                        if (dummyConfig[_i].indexOf("sentence") > -1) {

                            var args = dummyConfig[_i].substring(0, dummyConfig[_i].indexOf("sentence") - 1);

                            config.minSentences = parseInt(args.split('-')[0]);
                            config.maxSentences = parseInt(args.split('-')[1]);
                        } else if (dummyConfig[_i].indexOf("word") > -1) {

                            var _args = dummyConfig[_i].substring(0, dummyConfig[_i].indexOf("word") - 1);

                            config.minWords = parseInt(_args.split('-')[0]);
                            config.maxWords = parseInt(_args.split('-')[1]);
                        }
                    }
        ...
        generateLoremBlock: function generateLoremBlock(type, count, config) {
        ...
        loremSentences: function loremSentences(dict, number, config) {
        ...
        loremParagraphs: function loremParagraphs(dict, number, config) {

(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("RxQ", ["ws"], factory);
	else if(typeof exports === 'object')
		exports["RxQ"] = factory((function webpackLoadOptionalExternalModule() { try { return require("ws"); } catch(e) {} }()));
	else
		root["RxQ"] = factory(root["ws"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_428__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _engineSession = __webpack_require__(58);

	var _engineSession2 = _interopRequireDefault(_engineSession);

	var _engineWrapper = __webpack_require__(509);

	var _engineWrapper2 = _interopRequireDefault(_engineWrapper);

	var _rxjs = __webpack_require__(86);

	var _GlobalObservable = __webpack_require__(519);

	var _GlobalObservable2 = _interopRequireDefault(_GlobalObservable);

	var _AppObservable = __webpack_require__(521);

	var _AppObservable2 = _interopRequireDefault(_AppObservable);

	var _FieldObservable = __webpack_require__(525);

	var _FieldObservable2 = _interopRequireDefault(_FieldObservable);

	var _GenericBookmarkObservable = __webpack_require__(526);

	var _GenericBookmarkObservable2 = _interopRequireDefault(_GenericBookmarkObservable);

	var _GenericDimensionObservable = __webpack_require__(527);

	var _GenericDimensionObservable2 = _interopRequireDefault(_GenericDimensionObservable);

	var _GenericMeasureObservable = __webpack_require__(528);

	var _GenericMeasureObservable2 = _interopRequireDefault(_GenericMeasureObservable);

	var _GenericObjectObservable = __webpack_require__(529);

	var _GenericObjectObservable2 = _interopRequireDefault(_GenericObjectObservable);

	var _GenericVariableObservable = __webpack_require__(530);

	var _GenericVariableObservable2 = _interopRequireDefault(_GenericVariableObservable);

	var _VariableObservable = __webpack_require__(531);

	var _VariableObservable2 = _interopRequireDefault(_VariableObservable);

	var _package = __webpack_require__(532);

	var _package2 = _interopRequireDefault(_package);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	// polyfill function to enable function constructor.name in IE
	var RxQ = {
	    version: JSON.parse(_package2.default).version,
	    qObservables: {
	        GlobalObservable: _GlobalObservable2.default,
	        AppObservable: _AppObservable2.default,
	        FieldObservable: _FieldObservable2.default,
	        GenericBookmarkObservable: _GenericBookmarkObservable2.default,
	        GenericDimensionObservable: _GenericDimensionObservable2.default,
	        GenericMeasureObservable: _GenericMeasureObservable2.default,
	        GenericObjectObservable: _GenericObjectObservable2.default,
	        GenericVariableObservable: _GenericVariableObservable2.default,
	        VariableObservable: _VariableObservable2.default
	    },
	    connectEngine: function connectEngine(config) {
	        // Establish a session, then return a Qix Class type Global from it
	        return new _engineSession2.default(config).map(function (m) {
	            return m.getGlobal();
	        }).let(function (o) {
	            return new _GlobalObservable2.default(o);
	        });
	    },
	    $$: {
	        engine: _engineWrapper2.default
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _connection = __webpack_require__(81);

	var _connection2 = _interopRequireDefault(_connection);

	var _qixGlobal = __webpack_require__(429);

	var _qixGlobal2 = _interopRequireDefault(_qixGlobal);
	...
	var seqId = _regenerator2.default.mark(function seqId() {
	    var index;
	    return _regenerator2.default.wrap(function seqId$(_context) {
	        while (1) {
	...
	var EngineSession = function () {
	    function EngineSession(config) {
	        (0, _classCallCheck3.default)(this, EngineSession);


	        // Internals
	        var handle = -1;
	        var seqGen = _rxjs.Observable.from(seqId());

	        //const wsTraffic = new Connection(config);
	        var wsObs = new _connection2.default(config);
	    ...
	    (0, _createClass3.default)(EngineSession, [{
	        key: "getGlobal",
	        value: function getGlobal() {
	            return new _qixGlobal2.default(this, -1);
	        }
	    }]);
	    return EngineSession;
	}();

	exports.default = EngineSession;
	;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _qixConnectString = __webpack_require__(84);

	var _qixConnectString2 = _interopRequireDefault(_qixConnectString);

	var _qixConnectOptions = __webpack_require__(85);
	...
	var Connection = function Connection(config) {
	    ...
	    if (IS_NODE) {
	        try {
	            WebSocket = __webpack_require__(428);
	        } catch (e) {}
	    };
	    ...
	    var wsOpen = _rxjs.Observable.create(function (observer) {
	        var ws = IS_NODE ? new WebSocket(url, null, options) : new WebSocket(url);
	        ...
	        ws.addEventListener("open", function () {
	            ...
	            ws.send((0, _stringify2.default)(seedMsg));
	    ...
	    var wsTrafficIn = wsOpen.mergeMap(function (ws) {
	    ...
	    var wsPassed = wsTrafficIn.filter(function (f) {
	        return f.method === "OnAuthenticationInformation" && !f.params.mustAuthenticate;
	    }).mapTo(true).take(1).publishLast().refCount();

	    return { wsOpen: wsOpen, wsTrafficIn: wsTrafficIn, wsPassed: wsPassed };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReplaySubject_1 = __webpack_require__(204);
	exports.ReplaySubject = ReplaySubject_1.ReplaySubject;
	var BehaviorSubject_1 = __webpack_require__(328);
	exports.BehaviorSubject = BehaviorSubject_1.BehaviorSubject;
	var ConnectableObservable_1 = __webpack_require__(314);
	exports.ConnectableObservable = ConnectableObservable_1.ConnectableObservable;
	var Notification_1 = __webpack_require__(142);
	exports.Notification = Notification_1.Notification;
	var EmptyError_1 = __webpack_require__(276);
	exports.EmptyError = EmptyError_1.EmptyError;
	var ArgumentOutOfRangeError_1 = __webpack_require__(265);
	exports.ArgumentOutOfRangeError = ArgumentOutOfRangeError_1.ArgumentOutOfRangeError;
	var ObjectUnsubscribedError_1 = __webpack_require__(102);
	exports.ObjectUnsubscribedError = ObjectUnsubscribedError_1.ObjectUnsubscribedError;
	var TimeoutError_1 = __webpack_require__(393);
	exports.TimeoutError = TimeoutError_1.TimeoutError;
	var UnsubscriptionError_1 = __webpack_require__(98);
	exports.UnsubscriptionError = UnsubscriptionError_1.UnsubscriptionError;
	var timeInterval_1 = __webpack_require__(390);
	exports.TimeInterval = timeInterval_1.TimeInterval;
	var timestamp_1 = __webpack_require__(397);
	exports.Timestamp = timestamp_1.Timestamp;
	var TestScheduler_1 = __webpack_require__(417);
	exports.TestScheduler = TestScheduler_1.TestScheduler;
	var VirtualTimeScheduler_1 = __webpack_require__(423);
	exports.VirtualTimeScheduler = VirtualTimeScheduler_1.VirtualTimeScheduler;
	var AjaxObservable_1 = __webpack_require__(199);
	exports.AjaxResponse = AjaxObservable_1.AjaxResponse;
	exports.AjaxError = AjaxObservable_1.AjaxError;
	exports.AjaxTimeoutError = AjaxObservable_1.AjaxTimeoutError;
	var asap_1 = __webpack_require__(366);
	var async_1 = __webpack_require__(160);
	var queue_1 = __webpack_require__(205);
	var animationFrame_1 = __webpack_require__(424);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var isScheduler_1 = __webpack_require__(113);
	var isArray_1 = __webpack_require__(94);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EmptyObservable_1 = __webpack_require__(116);
	var isScheduler_1 = __webpack_require__(113);
	/**
	 * We need this JSDoc comment for affecting ESDoc.
	 * @extends {Ignored}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var subscribeToResult_1 = __webpack_require__(119);
	var none = {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isScheduler_1 = __webpack_require__(113);
	var ArrayObservable_1 = __webpack_require__(114);
	var mergeAll_1 = __webpack_require__(126);
	/* tslint:disable:max-line-length */
	function concat() {
	    var observables = [];
	    for (var _i = 0; _i < arguments.length; _i++) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var ForkJoinObservable_1 = __webpack_require__(134);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var from_1 = __webpack_require__(136);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var fromEvent_1 = __webpack_require__(144);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var fromEventPattern_1 = __webpack_require__(147);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var FromEventPatternObservable_1 = __webpack_require__(148);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var fromPromise_1 = __webpack_require__(150);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var GenerateObservable_1 = __webpack_require__(152);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var if_1 = __webpack_require__(154);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var IfObservable_1 = __webpack_require__(155);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isNumeric_1 = __webpack_require__(159);
	var Observable_1 = __webpack_require__(88);
	var async_1 = __webpack_require__(160);
	/**
	 * We need this JSDoc comment for affecting ESDoc.
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var AsyncAction_1 = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var root_1 = __webpack_require__(89);
	var Action_1 = __webpack_require__(162);
	/**
	 * We need this JSDoc comment for affecting ESDoc.
	 * @ignore
	 * @extends {Ignored}
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var onErrorResumeNext_1 = __webpack_require__(177);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var pairs_1 = __webpack_require__(179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var PairsObservable_1 = __webpack_require__(180);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var range_1 = __webpack_require__(182);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var RangeObservable_1 = __webpack_require__(183);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var using_1 = __webpack_require__(185);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var UsingObservable_1 = __webpack_require__(186);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var throw_1 = __webpack_require__(188);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var ErrorObservable_1 = __webpack_require__(189);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var timer_1 = __webpack_require__(191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var TimerObservable_1 = __webpack_require__(192);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var webSocket_1 = __webpack_require__(202);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var WebSocketSubject_1 = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tryCatch_1 = __webpack_require__(96);
	var errorObject_1 = __webpack_require__(97);
	var assign_1 = __webpack_require__(208);
	/**
	 * We need this JSDoc comment for affecting ESDoc.
	 * @extends {Ignored}
	 * @hide true
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var QueueAction_1 = __webpack_require__(206);
	var QueueScheduler_1 = __webpack_require__(207);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var buffer_1 = __webpack_require__(210);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var bufferCount_1 = __webpack_require__(212);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var bufferTime_1 = __webpack_require__(214);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var bufferToggle_1 = __webpack_require__(216);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var bufferWhen_1 = __webpack_require__(218);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var catch_1 = __webpack_require__(220);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var concatAll_1 = __webpack_require__(226);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var concatMapTo_1 = __webpack_require__(231);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var mergeMapTo_1 = __webpack_require__(232);
	/* tslint:disable:max-line-length */
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var count_1 = __webpack_require__(234);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var dematerialize_1 = __webpack_require__(236);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var debounce_1 = __webpack_require__(238);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var defaultIfEmpty_1 = __webpack_require__(242);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var delay_1 = __webpack_require__(244);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var delayWhen_1 = __webpack_require__(246);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var distinct_1 = __webpack_require__(248);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var distinctKey_1 = __webpack_require__(250);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var distinctUntilChanged_1 = __webpack_require__(252);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var distinctUntilKeyChanged_1 = __webpack_require__(254);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var do_1 = __webpack_require__(256);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FastMap_1 = __webpack_require__(281);
	/* tslint:disable:max-line-length */
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var root_1 = __webpack_require__(89);
	var MapPolyfill_1 = __webpack_require__(280);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var auditTime_1 = __webpack_require__(289);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var mergeScan_1 = __webpack_require__(309);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var multicast_1 = __webpack_require__(313);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var publishLast_1 = __webpack_require__(332);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var repeat_1 = __webpack_require__(336);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var retry_1 = __webpack_require__(340);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var retryWhen_1 = __webpack_require__(342);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var sample_1 = __webpack_require__(344);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var sampleTime_1 = __webpack_require__(346);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var scan_1 = __webpack_require__(348);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var single_1 = __webpack_require__(354);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var skip_1 = __webpack_require__(356);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var skipUntil_1 = __webpack_require__(358);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var startWith_1 = __webpack_require__(362);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var SubscribeOnObservable_1 = __webpack_require__(365);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var AsapAction_1 = __webpack_require__(367);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(369).clearImmediate, __webpack_require__(369).setImmediate))
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var switchMap_1 = __webpack_require__(374);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var switchMapTo_1 = __webpack_require__(376);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var takeLast_1 = __webpack_require__(380);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var takeUntil_1 = __webpack_require__(382);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var timeout_1 = __webpack_require__(392);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var timeoutWith_1 = __webpack_require__(395);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var windowToggle_1 = __webpack_require__(409);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var windowWhen_1 = __webpack_require__(411);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(88);
	var zipAll_1 = __webpack_require__(416);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Observable_1 = __webpack_require__(88);
	var Notification_1 = __webpack_require__(142);
	var ColdObservable_1 = __webpack_require__(418);
	var HotObservable_1 = __webpack_require__(422);
	var SubscriptionLog_1 = __webpack_require__(420);
	var VirtualTimeScheduler_1 = __webpack_require__(423);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var AnimationFrameAction_1 = __webpack_require__(425);
	var AnimationFrameScheduler_1 = __webpack_require__(427);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AsyncAction_1 = __webpack_require__(161);
	var AnimationFrame_1 = __webpack_require__(426);
	/**
	 * We need this JSDoc comment for affecting ESDoc.
	 * @ignore
	 * @extends {Ignored}
...
/***/ function(module, exports) {
	...
	if(typeof __WEBPACK_EXTERNAL_MODULE_428__ === 'undefined') {var e = new Error("Cannot find module \"ws\""); e.code = 'MODULE_NOT_FOUND'; throw e;}
	module.exports = __WEBPACK_EXTERNAL_MODULE_428__;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getPrototypeOf = __webpack_require__(430);
	...
	var _possibleConstructorReturn2 = __webpack_require__(441);
	...
	var _qixClass = __webpack_require__(496);

	var _qixClass2 = _interopRequireDefault(_qixClass);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var QixGlobal = function (_QixClass) {
	    (0, _inherits3.default)(QixGlobal, _QixClass);

	    function QixGlobal(session, handle, source, response) {
	        (0, _classCallCheck3.default)(this, QixGlobal);
	        return (0, _possibleConstructorReturn3.default)(this, (QixGlobal.__proto__ || (0, _getPrototypeOf2.default)(QixGlobal)).call(this, "Global", session, handle, source, response));
	    }

	    return QixGlobal;
	}(_qixClass2.default);

	exports.default = QixGlobal;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toObject        = __webpack_require__(433)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var shared = __webpack_require__(438)('keys')
	  , uid    = __webpack_require__(439);
	module.exports = function(key){
	  return shared[key] || (shared[key] = uid(key));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _typeof2 = __webpack_require__(442);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _iterator = __webpack_require__(443);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(471).f('iterator');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toInteger = __webpack_require__(447)
	  , defined   = __webpack_require__(434);
	// true  -> String#at
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LIBRARY        = __webpack_require__(449)
	  ...
	  , hide           = __webpack_require__(69)
	  , has            = __webpack_require__(436)
	  , Iterators      = __webpack_require__(451)
	  , $iterCreate    = __webpack_require__(452)
	  , setToStringTag = __webpack_require__(465)
	  , getPrototypeOf = __webpack_require__(435)
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(69)(IteratorPrototype, __webpack_require__(466)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var anObject    = __webpack_require__(71)
	  ...
	  , enumBugKeys = __webpack_require__(463)
	  , IE_PROTO    = __webpack_require__(437)('IE_PROTO')
	  , Empty       = function(){ /* empty */ }
	  , PROTOTYPE   = 'prototype';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dP       = __webpack_require__(70)
	  ...
	  , getKeys  = __webpack_require__(455);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// fallback for non-array-like ES3 and non-enumerable old V8 strings
	var cof = __webpack_require__(459);
	module.exports = Object('z').propertyIsEnumerable(0) ? Object : function(it){
	  return cof(it) == 'String' ? it.split('') : Object(it);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// false -> Array#indexOf
	// true  -> Array#includes
	var toIObject = __webpack_require__(457)
	  , toLength  = __webpack_require__(461)
	  , toIndex   = __webpack_require__(462);
	module.exports = function(IS_INCLUDES){
	  return function($this, el, fromIndex){
	    var O      = toIObject($this)
	      , length = toLength(O.length)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store      = __webpack_require__(438)('wks')
	  , uid        = __webpack_require__(439)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global        = __webpack_require__(65)
	  , hide          = __webpack_require__(69)
	  , Iterators     = __webpack_require__(451)
	  , TO_STRING_TAG = __webpack_require__(466)('toStringTag');
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var addToUnscopables = __webpack_require__(469)
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.f = __webpack_require__(466);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global         = __webpack_require__(65)
	  ...
	  , $export        = __webpack_require__(64)
	  , redefine       = __webpack_require__(450)
	  , META           = __webpack_require__(475).KEY
	  , $fails         = __webpack_require__(75)
	  , shared         = __webpack_require__(438)
	  , setToStringTag = __webpack_require__(465)
	  , uid            = __webpack_require__(439)
	  , wks            = __webpack_require__(466)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var META     = __webpack_require__(439)('meta')
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getKeys   = __webpack_require__(455)
	  , toIObject = __webpack_require__(457);
	module.exports = function(object, el){
	  var O      = toIObject(object)
	    , keys   = getKeys(O)
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 19.1.2.7 / 15.2.3.4 Object.getOwnPropertyNames(O)
	var $keys      = __webpack_require__(456)
	  , hiddenKeys = __webpack_require__(463).concat('length', 'prototype');
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(476)('asyncIterator');

/***/ },
/* 487 */
/***/ function(module, exports, __webpack_require__) {

	__webpack_require__(476)('observable');
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(67)(Function.call, __webpack_require__(484).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _slicedToArray2 = __webpack_require__(497);
	...
	var QixClass = function QixClass(type, session, handle, source, response) {
	    var _this = this;

	    (0, _classCallCheck3.default)(this, QixClass);
	    ...
	    var methods = _engineWrapper2.default[this.type];
	    var methodNames = (0, _keys2.default)(methods);

	    var wsOpen = session.obs.wsOpen;
	    var wsPassed = session.obs.wsPassed;
	    var wsTrafficIn = session.obs.wsTrafficIn;
	    var seqGen = session.seqGen;

	    this.invalidated$ = wsTrafficIn.filter(function (f) {
	        return f.hasOwnProperty("change") && f.change.indexOf(handle) > -1;
	    }).mapTo(this).startWith(this);

	    methodNames.forEach(function (e) {
	        var method = methods[e];
	        ...
	        _this[e] = function () {
	            ...
	            var id$ = seqGen.take(1);
	            return wsPassed.withLatestFrom(wsOpen, function (pass, ws) {
	                return ws;
	            }).combineLatest(id$).mergeMap(function (_ref) {
	                var _ref2 = (0, _slicedToArray3.default)(_ref, 2);

	                var ws = _ref2[0];
	                var id = _ref2[1];

	                return method.apply(undefined, [ws, _this.handle, id].concat(args));
	            }).map(function (d) {
	                if (d.hasOwnProperty("qReturn") && d.qReturn.hasOwnProperty("qType")) {
	                    var qClass = undefined;
	                    switch (d.qReturn.qType) {
	                        case "Global":
	                            qClass = __webpack_require__(429);
	                            break;
	                        case "Doc":
	                            qClass = __webpack_require__(511);
	                            break;
	                        case "Field":
	                            qClass = __webpack_require__(512);
	                            break;
	                        case "GenericBookmark":
	                            qClass = __webpack_require__(513);
	                            break;
	                        case "GenericDimension":
	                            qClass = __webpack_require__(514);
	                            break;
	                        case "GenericMeasure":
	                            qClass = __webpack_require__(515);
	                            break;
	                        case "GenericObject":
	                            qClass = __webpack_require__(516);
	                            break;
	                        case "GenericVariable":
	                            qClass = __webpack_require__(517);
	                            break;
	                        case "Variable":
	                            qClass = __webpack_require__(518);
	                            break;
	                    }
	                    return new qClass(session, d.qReturn.qHandle, _this, d);
	                } else {
	                    return { source: _this, response: d };
	                }
	            });
	        };
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsonspec = __webpack_require__(510);

	var qixSpecs = _interopRequireWildcard(_jsonspec);
	...
	var classes = qixSpecs.default.structs;
	var classNames = (0, _keys2.default)(classes);

	var engine = classNames.reduce(function (acc, curr) {
	    var methods = classes[curr];
	    var methodNames = (0, _keys2.default)(methods);

	    acc[curr] = methodNames.reduce(function (iAcc, iCurr) {
	        var method = methods[iCurr];
	        iAcc[iCurr] = function (ws, handle, id) {
	            for (var _len = arguments.length, args = Array(_len > 3 ? _len - 3 : 0), _key = 3; _key < _len; _key++) {
	                args[_key - 3] = arguments[_key];
	            }

	            return _rxjs.Observable.create(function (observer) {
	                var msgFn = function msgFn(evt) {
	                    observer.next(evt);
	                };
	                // Add listener
	                ...
	                ws.send((0, _stringify2.default)(msg));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QixApp = function (_QixClass) {
	    (0, _inherits3.default)(QixApp, _QixClass);

	    function QixApp(session, handle, source, response) {
	        (0, _classCallCheck3.default)(this, QixApp);

	        // Validation function 
	        var _this = (0, _possibleConstructorReturn3.default)(this, (QixApp.__proto__ || (0, _getPrototypeOf2.default)(QixApp)).call(this, "Doc", session, handle, source, response));

	        _this.layout$ = _this.invalidated$.mergeMap(function (a) {
	            return a.GetAppLayout();
	        });
	        return _this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QixField = function (_QixClass) {
	    (0, _inherits3.default)(QixField, _QixClass);

	    function QixField(session, handle, source, response) {
	        (0, _classCallCheck3.default)(this, QixField);

	        // Validation function 
	        var _this = (0, _possibleConstructorReturn3.default)(this, (QixField.__proto__ || (0, _getPrototypeOf2.default)(QixField)).call(this, "Field", session, handle, source, response));

	        _this.properties$ = _this.invalidated$.mergeMap(function (f) {
	            return f.GetNxProperties();
	        });
	        return _this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QixGenericBookmark = function (_QixClass) {
	    (0, _inherits3.default)(QixGenericBookmark, _QixClass);

	    function QixGenericBookmark(session, handle, source, response) {
	        (0, _classCallCheck3.default)(this, QixGenericBookmark);

	        // Validation function 
	        var _this = (0, _possibleConstructorReturn3.default)(this, (QixGenericBookmark.__proto__ || (0, _getPrototypeOf2.default)(QixGenericBookmark)).call(this, "GenericBookmark", session, handle, source, response));

	        _this.layout$ = _this.invalidated$.mergeMap(function (gb) {
	            return gb.GetLayout();
	        });
	        return _this;
	    }

	    return QixGenericBookmark;
	}(_qixClass2.default);

	exports.default = QixGenericBookmark;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QixGenericDimension = function (_QixClass) {
	    (0, _inherits3.default)(QixGenericDimension, _QixClass);

	    function QixGenericDimension(session, handle, source, response) {
	        (0, _classCallCheck3.default)(this, QixGenericDimension);

	        // Validation function 
	        var _this = (0, _possibleConstructorReturn3.default)(this, (QixGenericDimension.__proto__ || (0, _getPrototypeOf2.default)(QixGenericDimension)).call(this, "GenericDimension", session, handle, source, response));

	        _this.layout$ = _this.invalidated$.mergeMap(function (gd) {
	            return gd.GetLayout();
	        });
	        return _this;
	    }

	    return QixGenericDimension;
	}(_qixClass2.default);

	exports.default = QixGenericDimension;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QixGenericMeasure = function (_QixClass) {
	    (0, _inherits3.default)(QixGenericMeasure, _QixClass);

	    function QixGenericMeasure(session, handle, source, response) {
	        (0, _classCallCheck3.default)(this, QixGenericMeasure);

	        // Validation function 
	        var _this = (0, _possibleConstructorReturn3.default)(this, (QixGenericMeasure.__proto__ || (0, _getPrototypeOf2.default)(QixGenericMeasure)).call(this, "GenericMeasure", session, handle, source, response));

	        _this.layout$ = _this.invalidated$.mergeMap(function (gm) {
	            return gm.GetLayout();
	        });
	        return _this;
	    }

	    return QixGenericMeasure;
	}(_qixClass2.default);

	exports.default = QixGenericMeasure;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QixGenericObject = function (_QixClass) {
	    (0, _inherits3.default)(QixGenericObject, _QixClass);

	    function QixGenericObject(session, handle, source, response) {
	        (0, _classCallCheck3.default)(this, QixGenericObject);

	        // Validation function 
	        var _this = (0, _possibleConstructorReturn3.default)(this, (QixGenericObject.__proto__ || (0, _getPrototypeOf2.default)(QixGenericObject)).call(this, "GenericObject", session, handle, source, response));

	        _this.layout$ = _this.invalidated$.mergeMap(function (go) {
	            return go.GetLayout();
	        });
	        return _this;
	    }

	    return QixGenericObject;
	}(_qixClass2.default);

	exports.default = QixGenericObject;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QixGenericVariable = function (_QixClass) {
	    (0, _inherits3.default)(QixGenericVariable, _QixClass);

	    function QixGenericVariable(session, handle, source, response) {
	        (0, _classCallCheck3.default)(this, QixGenericVariable);

	        // Validation function 
	        var _this = (0, _possibleConstructorReturn3.default)(this, (QixGenericVariable.__proto__ || (0, _getPrototypeOf2.default)(QixGenericVariable)).call(this, "GenericVariable", session, handle, source, response));

	        _this.layout$ = _this.invalidated$.mergeMap(function (gv) {
	            return gv.GetLayout();
	        });
	        return _this;
	    }

	    return QixGenericVariable;
	}(_qixClass2.default);

	exports.default = QixGenericVariable;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QixVariable = function (_QixClass) {
	    (0, _inherits3.default)(QixVariable, _QixClass);

	    function QixVariable(session, handle, source, response) {
	        (0, _classCallCheck3.default)(this, QixVariable);

	        // Validation function 
	        var _this = (0, _possibleConstructorReturn3.default)(this, (QixVariable.__proto__ || (0, _getPrototypeOf2.default)(QixVariable)).call(this, "Variable", session, handle, source, response));

	        _this.layout$ = _this.invalidated$.mergeMap(function (v) {
	            return v.GetNxProperties();
	        });
	        return _this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nonLiftedOperators = __webpack_require__(520);

	var _nonLiftedOperators2 = _interopRequireDefault(_nonLiftedOperators);

	var _AppObservable = __webpack_require__(521);

	var _AppObservable2 = _interopRequireDefault(_AppObservable);

	var _qixExtendPrototype = __webpack_require__(523);

	var _qixExtendPrototype2 = _interopRequireDefault(_qixExtendPrototype);

	var _qixObsTypes = __webpack_require__(524);

	var _qixObsTypes2 = _interopRequireDefault(_qixObsTypes);
	...
	var GlobalObservable = function (_Observable) {
	    (0, _inherits3.default)(GlobalObservable, _Observable);

	    function GlobalObservable(source) {
	        (0, _classCallCheck3.default)(this, GlobalObservable);

	        var _this = (0, _possibleConstructorReturn3.default)(this, (GlobalObservable.__proto__ || (0, _getPrototypeOf2.default)(GlobalObservable)).call(this));

	        _this.source = source.mergeMap(function (m) {
	            if (m instanceof _qixGlobal2.default) {
	    ...
	    (0, _createClass3.default)(GlobalObservable, [{
	        key: "lift",
	        value: function lift(operator) {
	            var operatorName = operator.constructor.name;
	            var operatorCheck = operatorName.slice(0, 1).toLowerCase() + operatorName.slice(1, operatorName.indexOf("Operator"));

	            // If operator is on list, lift it. otherwise, return basic observable
	            var observable = _nonLiftedOperators2.default.indexOf(operatorCheck) < 0 ? new GlobalObservable() : new _rxjs.Observable();
	            observable.source = this;
	            observable.operator = operator;
	            return observable;
	        }
	...
	(0, _qixExtendPrototype2.default)(GlobalObservable, "Global");

	// Override certain properties to return DocObservables
	var outputs = _qixObsTypes2.default.Global;
	var qObs = {
	    "AppObservable": _AppObservable2.default
	};

	outputs.forEach(function (e) {
	    var methodName = e.method;
	    var methodNameOrig = methodName.slice(0, 1).toUpperCase() + methodName.slice(1);
	    var obsClass = qObs[e.obsType];
	    GlobalObservable.prototype[methodName] = function () {
	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }

	        return this.mergeMap(function (e) {
	            return e[methodNameOrig].apply(e, args);
	        }).let(function (o) {
	            return new obsClass(o);
	        });
	    };
	});

	exports.default = GlobalObservable;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QixObservable2 = __webpack_require__(522);

	var _QixObservable3 = _interopRequireDefault(_QixObservable2);
	...
	var _qixApp = __webpack_require__(511);

	var _qixApp2 = _interopRequireDefault(_qixApp);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var AppObservable = function (_QixObservable) {
	    (0, _inherits3.default)(AppObservable, _QixObservable);

	    function AppObservable(source) {
	        (0, _classCallCheck3.default)(this, AppObservable);

	        var _this = (0, _possibleConstructorReturn3.default)(this, (AppObservable.__proto__ || (0, _getPrototypeOf2.default)(AppObservable)).call(this));

	        _this.source = source.mergeMap(function (m) {
	            if (m instanceof _qixApp2.default) {
	                return Rx.Observable.of(m);
	            } else {
	    ...
	    (0, _createClass3.default)(AppObservable, [{
	        key: "lift",
	        value: function lift(operator) {
	            var operatorName = operator.constructor.name;
	            var operatorCheck = operatorName.slice(0, 1).toLowerCase() + operatorName.slice(1, operatorName.indexOf("Operator"));
	            ...
	            // If operator is on list, lift it. otherwise, return basic observable
	            var observable = _nonLiftedOperators2.default.indexOf(operatorCheck) < 0 ? new AppObservable() : new _rxjs.Observable();
	            observable.source = this;
	            observable.operator = operator;
	            return observable;
	        }
	        ...
	        value: function layouts() {
	            ...
	            return _rxjs.Observable.of('').mergeMap(function () {
	                return _this2.mergeMap(function (q) {
	                    return q.layout$;
	                });
	            });
	        }
	...
	}(_QixObservable3.default);

	// Add in QIX operators for Docs


	(0, _qixExtendPrototype2.default)(AppObservable, "Doc");

	// Override certain properties to return qix observable subclasses
	var outputs = _qixObsTypes2.default.Doc;
	var qObs = {
	    FieldObservable: _FieldObservable2.default,
	    GenericBookmarkObservable: _GenericBookmarkObservable2.default,
	    GenericDimensionObservable: _GenericDimensionObservable2.default,
	...
	outputs.forEach(function (e) {
	    ...
	    var methodNameOrig = methodName.slice(0, 1).toUpperCase() + methodName.slice(1);
	    var obsClass = qObs[e.obsType];
	    AppObservable.prototype[methodName] = function () {
	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QixObservable = function (_Observable) {
	    (0, _inherits3.default)(QixObservable, _Observable);

	    function QixObservable(source) {
	        (0, _classCallCheck3.default)(this, QixObservable);

	        var _this = (0, _possibleConstructorReturn3.default)(this, (QixObservable.__proto__ || (0, _getPrototypeOf2.default)(QixObservable)).call(this));

	        _this.source = source;
	        return _this;
	    }

	    (0, _createClass3.default)(QixObservable, [{
	        key: "lift",
	        value: function lift(operator) {
	            ...
	            // If operator is on list, lift it. otherwise, return basic observable
	            var observable = _nonLiftedOperators2.default.indexOf(operatorCheck) < 0 ? new QixObservable() : new _rxjs.Observable();
	            observable.source = this;
	            observable.operator = operator;
	            return observable;
	        }
	        ...
	        key: "invalidated",
	        value: function invalidated() {
	            return this.mergeMap(function (q) {
	                return q.invalidated$;
	            });
	        }
	    }]);
	    return QixObservable;
	}(_rxjs.Observable);

	exports.default = QixObservable;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (proto, type) {
	    var methods = _engineWrapper2.default[type];
	    var methodNames = (0, _keys2.default)(methods);

	    methodNames.forEach(function (methodName) {
	        var method = methods[methodName];
	        var methodCamel = methodName.slice(0, 1).toLowerCase() + methodName.slice(1);

	        proto.prototype[methodCamel] = function () {
	            for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	                args[_key] = arguments[_key];
	            }

	            var responseObservable = this.mergeMap(function (e) {
	                return e[methodName].apply(e, args);
	            });

	            var observable = new _rxjs.Observable();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _qixField = __webpack_require__(512);

	var _qixField2 = _interopRequireDefault(_qixField);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var FieldObservable = function (_QixObservable) {
	    (0, _inherits3.default)(FieldObservable, _QixObservable);

	    function FieldObservable(source) {
	        (0, _classCallCheck3.default)(this, FieldObservable);

	        var _this = (0, _possibleConstructorReturn3.default)(this, (FieldObservable.__proto__ || (0, _getPrototypeOf2.default)(FieldObservable)).call(this));

	        _this.source = source.mergeMap(function (m) {
	            if (m instanceof _qixField2.default) {
	                return Rx.Observable.of(m);
	            } else {
	    ...
	    (0, _createClass3.default)(FieldObservable, [{
	        key: "lift",
	        value: function lift(operator) {
	            var operatorName = operator.constructor.name;
	            var operatorCheck = operatorName.slice(0, 1).toLowerCase() + operatorName.slice(1, operatorName.indexOf("Operator"));
	            ...
	            // If operator is on list, lift it. otherwise, return basic observable
	            var observable = _nonLiftedOperators2.default.indexOf(operatorCheck) < 0 ? new FieldObservable() : new _rxjs.Observable();
	            observable.source = this;
	            observable.operator = operator;
	            return observable;
	        }
	...
	(0, _qixExtendPrototype2.default)(FieldObservable, "Field");

	// Override any properties that should return observable sub classes
	var outputs = _qixObsTypes2.default.Field;
	var qObs = {};
	...
	outputs.forEach(function (e) {
	    ...
	    var methodNameOrig = methodName.slice(0, 1).toUpperCase() + methodName.slice(1);
	    var obsClass = qObs[e.obsType];
	    FieldObservable.prototype[methodName] = function () {
	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }
	...
	exports.default = FieldObservable;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _qixGenericBookmark = __webpack_require__(513);

	var _qixGenericBookmark2 = _interopRequireDefault(_qixGenericBookmark);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var GenericBookmarkObservable = function (_QixObservable) {
	    (0, _inherits3.default)(GenericBookmarkObservable, _QixObservable);

	    function GenericBookmarkObservable(source) {
	        (0, _classCallCheck3.default)(this, GenericBookmarkObservable);

	        var _this = (0, _possibleConstructorReturn3.default)(this, (GenericBookmarkObservable.__proto__ || (0, _getPrototypeOf2.default)(GenericBookmarkObservable)).call(this));

	        _this.source = source.mergeMap(function (m) {
	            if (m instanceof _qixGenericBookmark2.default) {
	                return Rx.Observable.of(m);
	            } else {
	    ...
	    (0, _createClass3.default)(GenericBookmarkObservable, [{
	        key: "lift",
	        value: function lift(operator) {
	            var operatorName = operator.constructor.name;
	            var operatorCheck = operatorName.slice(0, 1).toLowerCase() + operatorName.slice(1, operatorName.indexOf("Operator"));
	            ...
	            // If operator is on list, lift it. otherwise, return basic observable
	            var observable = _nonLiftedOperators2.default.indexOf(operatorCheck) < 0 ? new GenericBookmarkObservable() : new _rxjs.Observable();
	            observable.source = this;
	            observable.operator = operator;
	            return observable;
	        }
	    ...
	    return GenericBookmarkObservable;
	}(_QixObservable3.default);

	// Add in QIX operators


	(0, _qixExtendPrototype2.default)(GenericBookmarkObservable, "GenericBookmark");

	// Override any properties that should return observable sub classes
	var outputs = _qixObsTypes2.default.GenericBookmark;
	var qObs = {};
	...
	outputs.forEach(function (e) {
	    ...
	    var methodNameOrig = methodName.slice(0, 1).toUpperCase() + methodName.slice(1);
	    var obsClass = qObs[e.obsType];
	    GenericBookmarkObservable.prototype[methodName] = function () {
	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }
	...
	exports.default = GenericBookmarkObservable;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _qixGenericDimension = __webpack_require__(514);

	var _qixGenericDimension2 = _interopRequireDefault(_qixGenericDimension);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var GenericDimensionObservable = function (_QixObservable) {
	    (0, _inherits3.default)(GenericDimensionObservable, _QixObservable);

	    function GenericDimensionObservable(source) {
	        (0, _classCallCheck3.default)(this, GenericDimensionObservable);

	        var _this = (0, _possibleConstructorReturn3.default)(this, (GenericDimensionObservable.__proto__ || (0, _getPrototypeOf2.default)(GenericDimensionObservable)).call(this));

	        _this.source = source.mergeMap(function (m) {
	            if (m instanceof _qixGenericDimension2.default) {
	                return Rx.Observable.of(m);
	            } else {
	    ...
	    (0, _createClass3.default)(GenericDimensionObservable, [{
	        key: "lift",
	        value: function lift(operator) {
	            var operatorName = operator.constructor.name;
	            var operatorCheck = operatorName.slice(0, 1).toLowerCase() + operatorName.slice(1, operatorName.indexOf("Operator"));
	            ...
	            // If operator is on list, lift it. otherwise, return basic observable
	            var observable = _nonLiftedOperators2.default.indexOf(operatorCheck) < 0 ? new GenericDimensionObservable() : new _rxjs.Observable();
	            observable.source = this;
	            observable.operator = operator;
	            return observable;
	        }
	    ...
	    return GenericDimensionObservable;
	}(_QixObservable3.default);

	// Add in QIX operators


	(0, _qixExtendPrototype2.default)(GenericDimensionObservable, "GenericDimension");

	// Override any properties that should return observable sub classes
	var outputs = _qixObsTypes2.default.GenericDimension;
	var qObs = {};
	...
	outputs.forEach(function (e) {
	    ...
	    var methodNameOrig = methodName.slice(0, 1).toUpperCase() + methodName.slice(1);
	    var obsClass = qObs[e.obsType];
	    GenericDimensionObservable.prototype[methodName] = function () {
	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }
	...
	exports.default = GenericDimensionObservable;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _qixGenericMeasure = __webpack_require__(515);

	var _qixGenericMeasure2 = _interopRequireDefault(_qixGenericMeasure);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var GenericMeasureObservable = function (_QixObservable) {
	    (0, _inherits3.default)(GenericMeasureObservable, _QixObservable);

	    function GenericMeasureObservable(source) {
	        (0, _classCallCheck3.default)(this, GenericMeasureObservable);

	        var _this = (0, _possibleConstructorReturn3.default)(this, (GenericMeasureObservable.__proto__ || (0, _getPrototypeOf2.default)(GenericMeasureObservable)).call(this));

	        _this.source = source.mergeMap(function (m) {
	            if (m instanceof _qixGenericMeasure2.default) {
	                return Rx.Observable.of(m);
	            } else {
	    ...
	    (0, _createClass3.default)(GenericMeasureObservable, [{
	        key: "lift",
	        value: function lift(operator) {
	            var operatorName = operator.constructor.name;
	            var operatorCheck = operatorName.slice(0, 1).toLowerCase() + operatorName.slice(1, operatorName.indexOf("Operator"));
	            ...
	            // If operator is on list, lift it. otherwise, return basic observable
	            var observable = _nonLiftedOperators2.default.indexOf(operatorCheck) < 0 ? new GenericMeasureObservable() : new _rxjs.Observable();
	            observable.source = this;
	            observable.operator = operator;
	            return observable;
	        }
	    ...
	    return GenericMeasureObservable;
	}(_QixObservable3.default);

	// Add in QIX operators


	(0, _qixExtendPrototype2.default)(GenericMeasureObservable, "GenericMeasure");

	// Override any properties that should return observable sub classes
	var outputs = _qixObsTypes2.default.GenericMeasure;
	var qObs = {};
	...
	outputs.forEach(function (e) {
	    ...
	    var methodNameOrig = methodName.slice(0, 1).toUpperCase() + methodName.slice(1);
	    var obsClass = qObs[e.obsType];
	    GenericMeasureObservable.prototype[methodName] = function () {
	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }
	...
	exports.default = GenericMeasureObservable;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _qixGenericObject = __webpack_require__(516);

	var _qixGenericObject2 = _interopRequireDefault(_qixGenericObject);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var GenericObjectObservable = function (_QixObservable) {
	    (0, _inherits3.default)(GenericObjectObservable, _QixObservable);

	    function GenericObjectObservable(source) {
	        (0, _classCallCheck3.default)(this, GenericObjectObservable);

	        var _this = (0, _possibleConstructorReturn3.default)(this, (GenericObjectObservable.__proto__ || (0, _getPrototypeOf2.default)(GenericObjectObservable)).call(this));

	        _this.source = source.mergeMap(function (m) {
	            if (m instanceof _qixGenericObject2.default) {
	                return Rx.Observable.of(m);
	            } else {
	    ...
	    (0, _createClass3.default)(GenericObjectObservable, [{
	        key: "lift",
	        value: function lift(operator) {
	            var operatorName = operator.constructor.name;
	            var operatorCheck = operatorName.slice(0, 1).toLowerCase() + operatorName.slice(1, operatorName.indexOf("Operator"));
	            ...
	            // If operator is on list, lift it. otherwise, return basic observable
	            var observable = _nonLiftedOperators2.default.indexOf(operatorCheck) < 0 ? new GenericObjectObservable() : new _rxjs.Observable();
	            observable.source = this;
	            observable.operator = operator;
	            return observable;
	        }
	    ...
	    return GenericObjectObservable;
	}(_QixObservable3.default);

	// Add in QIX operators for global


	(0, _qixExtendPrototype2.default)(GenericObjectObservable, "GenericObject");

	// Override any properties that should return observable sub classes
	var outputs = _qixObsTypes2.default.GenericObject;
	var qObs = {};
	...
	outputs.forEach(function (e) {
	    ...
	    var methodNameOrig = methodName.slice(0, 1).toUpperCase() + methodName.slice(1);
	    var obsClass = qObs[e.obsType];
	    GenericObjectObservable.prototype[methodName] = function () {
	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }
	...
	exports.default = GenericObjectObservable;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _qixGenericVariable = __webpack_require__(517);

	var _qixGenericVariable2 = _interopRequireDefault(_qixGenericVariable);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var GenericVariableObservable = function (_QixObservable) {
	    (0, _inherits3.default)(GenericVariableObservable, _QixObservable);

	    function GenericVariableObservable(source) {
	        (0, _classCallCheck3.default)(this, GenericVariableObservable);

	        var _this = (0, _possibleConstructorReturn3.default)(this, (GenericVariableObservable.__proto__ || (0, _getPrototypeOf2.default)(GenericVariableObservable)).call(this));

	        _this.source = source.mergeMap(function (m) {
	            if (m instanceof _qixGenericVariable2.default) {
	                return Rx.Observable.of(m);
	            } else {
	    ...
	    (0, _createClass3.default)(GenericVariableObservable, [{
	        key: "lift",
	        value: function lift(operator) {
	            var operatorName = operator.constructor.name;
	            var operatorCheck = operatorName.slice(0, 1).toLowerCase() + operatorName.slice(1, operatorName.indexOf("Operator"));
	            ...
	            // If operator is on list, lift it. otherwise, return basic observable
	            var observable = _nonLiftedOperators2.default.indexOf(operatorCheck) < 0 ? new GenericVariableObservable() : new _rxjs.Observable();
	            observable.source = this;
	            observable.operator = operator;
	            return observable;
	        }
	    ...
	    return GenericVariableObservable;
	}(_QixObservable3.default);

	// Add in QIX operators for global


	(0, _qixExtendPrototype2.default)(GenericVariableObservable, "GenericVariable");

	// Override any properties that should return observable sub classes
	var outputs = _qixObsTypes2.default.GenericVariable;
	var qObs = {};
	...
	outputs.forEach(function (e) {
	    ...
	    var methodNameOrig = methodName.slice(0, 1).toUpperCase() + methodName.slice(1);
	    var obsClass = qObs[e.obsType];
	    GenericVariableObservable.prototype[methodName] = function () {
	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }
	...
	exports.default = GenericVariableObservable;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _qixVariable = __webpack_require__(518);

	var _qixVariable2 = _interopRequireDefault(_qixVariable);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var VariableObservable = function (_QixObservable) {
	    (0, _inherits3.default)(VariableObservable, _QixObservable);

	    function VariableObservable(source) {
	        (0, _classCallCheck3.default)(this, VariableObservable);

	        var _this = (0, _possibleConstructorReturn3.default)(this, (VariableObservable.__proto__ || (0, _getPrototypeOf2.default)(VariableObservable)).call(this));

	        _this.source = source.mergeMap(function (m) {
	            if (m instanceof _qixVariable2.default) {
	                return Rx.Observable.of(m);
	            } else {
	    ...
	    (0, _createClass3.default)(VariableObservable, [{
	        key: "lift",
	        value: function lift(operator) {
	            var operatorName = operator.constructor.name;
	            var operatorCheck = operatorName.slice(0, 1).toLowerCase() + operatorName.slice(1, operatorName.indexOf("Operator"));
	            ...
	            // If operator is on list, lift it. otherwise, return basic observable
	            var observable = _nonLiftedOperators2.default.indexOf(operatorCheck) < 0 ? new VariableObservable() : new _rxjs.Observable();
	            observable.source = this;
	            observable.operator = operator;
	            return observable;
	        }
	...
	(0, _qixExtendPrototype2.default)(VariableObservable, "Variable");

	// Override any properties that should return observable sub classes
	var outputs = _qixObsTypes2.default.Variable;
	var qObs = {};
	...
	outputs.forEach(function (e) {
	    ...
	    var methodNameOrig = methodName.slice(0, 1).toUpperCase() + methodName.slice(1);
	    var obsClass = qObs[e.obsType];
	    VariableObservable.prototype[methodName] = function () {
	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }
	...
	exports.default = VariableObservable;
	module.exports = exports["default"];

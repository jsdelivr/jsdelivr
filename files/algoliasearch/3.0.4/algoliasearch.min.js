...
f){d.super_=f;var c=function(){};c.prototype=f.prototype;d.prototype=new c;d.prototype.constructor=d}},{}],7:[function(h,l,d){l.exports={name:"algoliasearch",version:"3.0.4",description:"AlgoliaSearch API JavaScript client",main:"index.js",browser:{"index.js":"src/browser/builds/algoliasearch.js","src/version/index.js":"src/version/browser.js"},scripts:{build:"PACKAGE_VERSION=$(json -f package.json version) sh build.sh",test:"npm run test-phantom | tap-spec && npm run test-node | tap-spec && npm run lint",
"test-node":"node test/run-node.js","test-phantom":"zuul --phantom -- test/run-browser.js","test-ci-browser":"DEBUG=zuul* zuul --tunnel ngrok -- test/run-browser.js",dev:"NODE_ENV=development DEBUG=zuul* zuul --no-coverage --local 8080 -- test/run-browser.js",examples:"http-server . -a 0.0.0.0",lint:"eslint --quiet test/"},browserify:{transform:["envify","packageify"]},repository:{type:"git",url:"git://github.com/algolia/algoliasearch-client-js.git"},keywords:"algolia;search;search api;instant search;realtime;autocomplete".split(";"),
homepage:"https://github.com/algolia/algoliasearch-client-js",bugs:"https://github.com/algolia/algoliasearch-client-js/issues",author:{name:"Algolia SAS",url:"https://www.algolia.com"},contributors:[{name:"Algolia Team <support@algolia.com>",url:"http://www.algolia.com"}],dependencies:{agentkeepalive:"0.2.4",debug:"2.1.3",envify:"3.4.0","es6-promise":"2.0.1",inherits:"2.0.1","load-script":"1.0.0",once:"1.3.1",packageify:"0.2.2",semver:"4.3.2"},devDependencies:{angular:"1.3.14",async:"0.9.0",bowser:"0.7.2",
browserify:"9.0.3","bulk-require":"0.2.1",bulkify:"1.1.1","bundle-collapser":"1.1.4",chance:"0.7.3",closurecompiler:"1.5.1",compression:"1.4.3",deumdify:"1.1.0",domready:"0.3.0",eslint:"0.15.0",express:"4.12.1","faux-jax":"4.0.0-beta.1","http-server":"0.7.5","jQuery-ajaxTransport-XDomainRequest":"git://github.com/MoonScript/jQuery-ajaxTransport-XDomainRequest#1.0.4",jquery:"2.1.3",json:"9.0.3",lodash:"3.5.0","lodash-compat":"3.5.0",morgan:"1.5.1",phantomjs:"1.9.15","pretty-bytes":"1.0.4",sinon:"1.12.2",
"tap-spec":"2.2.1",tape:"3.5.0","url-parse":"1.0.0",xhr:"2.0.1",zuul:"2.1.1","zuul-ngrok":"3.0.0"}}},{}],8:[function(h,l,d){(function(d,f){function c(a,b,g){if(!a)throw Error("Please provide an application ID. Usage: algoliasearch(applicationID, apiKey, opts)");if(!b)throw Error("Please provide an API key. Usage: algoliasearch(applicationID, apiKey, opts)");g=g||{};void 0===g.timeout&&(g.timeout=2E3);if(void 0===g.protocol){var c=f.document&&f.document.location.protocol;g.protocol="http:"===c||"https:"===
c?c:"http:"}void 0===g.hosts&&(g.hosts=[]);void 0===g.tld&&(g.tld="net");/:$/.test(g.protocol)||(g.protocol+=":");0===g.hosts.length&&(g.hosts=e([a+"-1.algolia."+g.tld,a+"-2.algolia."+g.tld,a+"-3.algolia."+g.tld]),g.hosts.unshift(a+"-dsn.algolia."+g.tld));g.hosts=k(g.hosts,function(a){return g.protocol+"//"+a});this.applicationID=a;this.apiKey=b;this.hosts=g.hosts;this.currentHostIndex=0;this.requestTimeout=g.timeout;this.extraHeaders=[];this.cache={}}function k(a,b){for(var g=[],c=0;c<a.length;++c)g.push(b(a[c],
c));return g}function e(a){for(var b=a.length,c,d;0!==b;)d=Math.floor(Math.random()*b),--b,c=a[b],a[b]=a[d],a[d]=c;return a}l.exports=c;"development"===d.env.NODE_ENV&&h(2).enable("algoliasearch*");var u=h(2)("algoliasearch:AlgoliaSearch");c.prototype={deleteIndex:function(a,b){return this._jsonRequest({method:"DELETE",url:"/1/indexes/"+encodeURIComponent(a),callback:b})},moveIndex:function(a,b,c){b={operation:"move",destination:b};return this._jsonRequest({method:"POST",url:"/1/indexes/"+encodeURIComponent(a)+
"/operation",body:b,callback:c})},copyIndex:function(a,b,c){b={operation:"copy",destination:b};return this._jsonRequest({method:"POST",url:"/1/indexes/"+encodeURIComponent(a)+"/operation",body:b,callback:c})},getLogs:function(a,b,c){if(0===arguments.length||"function"===typeof a)c=a,a=0,b=10;else if(1===arguments.length||"function"===typeof b)c=b,b=10;return this._jsonRequest({method:"GET",url:"/1/logs?offset="+a+"&length="+b,callback:c})},listIndexes:function(a,b){var c="";void 0===a||"function"===
typeof a?b=a:c="?page="+a;return this._jsonRequest({method:"GET",url:"/1/indexes"+c,callback:b})},initIndex:function(a){return new this.Index(this,a)},listUserKeys:function(a){return this._jsonRequest({method:"GET",url:"/1/keys",callback:a})},getUserKeyACL:function(a,b){return this._jsonRequest({method:"GET",url:"/1/keys/"+a,callback:b})},deleteUserKey:function(a,b){return this._jsonRequest({method:"DELETE",url:"/1/keys/"+a,callback:b})},addUserKey:function(a,b){return this.addUserKeyWithValidity(a,
...
url:"/1/indexes/"+encodeURIComponent(this.indexName),body:{params:a}},callback:b})},as:null,indexName:null,typeAheadArgs:null,typeAheadValueOption:null}}).call(this,h(1),"undefined"!==typeof global?global:"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{1:1,2:2}],9:[function(h,l,d){(function(d){function f(a,b,d){return new c(a,b,d)}function c(){u.apply(this,arguments)}l.exports=f;var k=h(6),e=d.Promise||h(5).Promise,u=h(8),a=h(10);f.version=h(11);var b="XDomainRequest"in window,
...
{reject:function(a){return e.reject(a)},resolve:function(a){return e.resolve(a)},delay:function(a){return new e(function(b){setTimeout(b,a)})}}}).call(this,"undefined"!==typeof global?global:"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{10:10,11:11,5:5,6:6,8:8}],10:[function(h,l,d){l.exports=function(d,c,h){function e(){t||r||(t=!0,p||(a(),h(Error("Failed to load JSONP script"))))}function l(){"loaded"!==this.readyState&&"complete"!==this.readyState||e()}function a(){clearTimeout(q);
n.onload=null;n.onreadystatechange=null;n.onerror=null;E.removeChild(n);try{delete window[v],delete window[v+"_loaded"]}catch(a){window[v]=null,window[v+"_loaded"]=null}}function b(){r=!0;a();h(Error("Timeout - Could not connect to endpoint "+d))}function g(){t||r||(a(),h(Error("Failed to load JSONP script")))}if("GET"!==c.method)h(Error("Method "+c.method+" "+d+" is not supported by JSONP."));else{var p=!1,r=!1;m+=1;var E=document.getElementsByTagName("head")[0],n=document.createElement("script"),
v="algoliaJSONP_"+m,t=!1;window[v]=function(b){try{delete window[v]}catch(c){window[v]=void 0}r||(p=!0,a(),h(null,{body:b}))};d+="&callback="+v;c.body&&c.body.params&&(d+="&"+c.body.params);var q=setTimeout(b,c.timeout);n.onreadystatechange=l;n.onload=e;n.onerror=g;n.async=!0;n.defer=!0;n.src=d;E.appendChild(n)}};var m=0},{}],11:[function(h,l,d){l.exports=h(7).version},{7:7}]},{},[9])(9)});

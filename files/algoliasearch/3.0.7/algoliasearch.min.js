...
url:"/1/indexes/"+encodeURIComponent(this.indexName)+"/batch",body:c,callback:b})},deleteObject:function(a,b){if("function"===typeof a||"string"!==typeof a&&"number"!==typeof a){var c=Error("Cannot delete an object without an objectID");b=a;return"function"===typeof b?b(c):this.as._promise.reject(c)}return this.as._jsonRequest({method:"DELETE",url:"/1/indexes/"+encodeURIComponent(this.indexName)+"/"+encodeURIComponent(a),callback:b})},search:function(a,b,c){if("function"===typeof a&&"object"===typeof b||
"object"===typeof c)throw Error("AlgoliaSearch: index.search usage is index.search(query, params, cb)");if(0===arguments.length||"function"===typeof a)c=a,a="";else if(1===arguments.length||"function"===typeof b)c=b,b=void 0;if("object"===typeof a&&null!==a)b=a,a=void 0;else if(void 0===a||null===a)a="";var d="";void 0!==a&&(d+="query="+encodeURIComponent(a));void 0!==b&&(d=this.as._getSearchParams(b,d));return this._search(d,c)},browse:function(a,b,c){if(1===arguments.length||"function"===typeof b)c=
b,b=void 0;var d="?page="+a;this.as._isUndefined(b)||(d+="&hitsPerPage="+b);return this.as._jsonRequest({method:"GET",url:"/1/indexes/"+encodeURIComponent(this.indexName)+"/browse"+d,callback:c})},ttAdapter:function(a){var b=this;return function(c,d){b.search(c,a,function(a,b){a?d(a):d(b.hits)})}},waitTask:function(a,b){var c=this,e=this.as._jsonRequest({method:"GET",url:"/1/indexes/"+encodeURIComponent(c.indexName)+"/task/"+a}).then(function(e){if("published"!==e.status)return(new c.as._promise.delay(100)).then(function(){return c.waitTask(a,
b)});if(b)d.nextTick(function(){b(null,e)});else return e},function(a){if(b)d.nextTick(function(){b(a)});else return a});if(!b)return e},clearIndex:function(a){return this.as._jsonRequest({method:"POST",url:"/1/indexes/"+encodeURIComponent(this.indexName)+"/clear",callback:a})},getSettings:function(a){return this.as._jsonRequest({method:"GET",url:"/1/indexes/"+encodeURIComponent(this.indexName)+"/settings",callback:a})},setSettings:function(a,b){return this.as._jsonRequest({method:"PUT",url:"/1/indexes/"+
encodeURIComponent(this.indexName)+"/settings",body:a,callback:b})},listUserKeys:function(a){return this.as._jsonRequest({method:"GET",url:"/1/indexes/"+encodeURIComponent(this.indexName)+"/keys",callback:a})},getUserKeyACL:function(a,b){return this.as._jsonRequest({method:"GET",url:"/1/indexes/"+encodeURIComponent(this.indexName)+"/keys/"+a,callback:b})},deleteUserKey:function(a,b){return this.as._jsonRequest({method:"DELETE",url:"/1/indexes/"+encodeURIComponent(this.indexName)+"/keys/"+a,callback:b})},
addUserKey:function(a,b){var c={};c.acl=a;return this.as._jsonRequest({method:"POST",url:"/1/indexes/"+encodeURIComponent(this.indexName)+"/keys",body:c,callback:b})},addUserKeyWithValidity:function(a,b,c){var d={};d.acl=a;d.validity=b.validity;d.maxQueriesPerIPPerHour=b.maxQueriesPerIPPerHour;d.maxHitsPerQuery=b.maxHitsPerQuery;return this.as._jsonRequest({method:"POST",url:"/1/indexes/"+encodeURIComponent(this.indexName)+"/keys",body:d,callback:c})},_search:function(a,b){return this.as._jsonRequest({cache:this.cache,
method:"POST",url:"/1/indexes/"+encodeURIComponent(this.indexName)+"/query",body:{params:a},fallback:{method:"GET",url:"/1/indexes/"+encodeURIComponent(this.indexName),body:{params:a}},callback:b})},as:null,indexName:null,typeAheadArgs:null,typeAheadValueOption:null}}).call(this,h(1),"undefined"!==typeof global?global:"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{1:1,2:2}],8:[function(h,l,d){(function(d){function f(a,b,d){return new c(a,b,d)}function c(){u.apply(this,arguments)}
l.exports=f;var k=h(6),e=d.Promise||h(5).Promise,u=h(7),a=h(9);f.version=h(10);var b="XDomainRequest"in window,g="withCredentials"in new XMLHttpRequest,p="timeout"in new XMLHttpRequest;k(c,u);c.prototype._request=function(a,c){return new e(function(d,e){function f(){if(!D){p||clearTimeout(u);var a=null;try{a=JSON.parse(m.responseText)}catch(b){}d({body:a,statusCode:m.status})}}function k(a){D||(p||clearTimeout(u),e(Error("Could not connect to host, error was:"+a)))}function h(){p||(D=!0,m.abort());
d(Error("Timeout - Could not connect to endpoint "+a))}if(g||b){var l=null,m=g?new XMLHttpRequest:new XDomainRequest,u,D;void 0!==c.body&&(l=JSON.stringify(c.body));m instanceof XMLHttpRequest?m.open(c.method,a,!0):m.open(c.method,a);g&&null!==l&&"GET"!==c.method&&m.setRequestHeader("content-type","application/x-www-form-urlencoded");m.onprogress=function(){};m.onload=f;m.onerror=k;p?(m.timeout=c.timeout,m.ontimeout=h):u=setTimeout(h,c.timeout);m.send(l)}else e(Error("CORS not supported"))})};c.prototype._request.fallback=
function(b,c){return new e(function(d,e){a(b,c,function(a,b){a?e(a):d(b)})})};c.prototype._promise={reject:function(a){return e.reject(a)},resolve:function(a){return e.resolve(a)},delay:function(a){return new e(function(b){setTimeout(b,a)})}}}).call(this,"undefined"!==typeof global?global:"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{10:10,5:5,6:6,7:7,9:9}],9:[function(h,l,d){l.exports=function(d,c,k){function e(){t||r||(t=!0,l||(a(),k(Error("Failed to load JSONP script"))))}
function h(){"loaded"!==this.readyState&&"complete"!==this.readyState||e()}function a(){clearTimeout(q);n.onload=null;n.onreadystatechange=null;n.onerror=null;E.removeChild(n);try{delete window[v],delete window[v+"_loaded"]}catch(a){window[v]=null,window[v+"_loaded"]=null}}function b(){r=!0;a();k(Error("Timeout - Could not connect to endpoint "+d))}function g(){t||r||(a(),k(Error("Failed to load JSONP script")))}if("GET"!==c.method)k(Error("Method "+c.method+" "+d+" is not supported by JSONP."));
else{var l=!1,r=!1;m+=1;var E=document.getElementsByTagName("head")[0],n=document.createElement("script"),v="algoliaJSONP_"+m,t=!1;window[v]=function(b){try{delete window[v]}catch(c){window[v]=void 0}r||(l=!0,a(),k(null,{body:b}))};d+="&callback="+v;c.body&&c.body.params&&(d+="&"+c.body.params);var q=setTimeout(b,c.timeout);n.onreadystatechange=h;n.onload=e;n.onerror=g;n.async=!0;n.defer=!0;n.src=d;E.appendChild(n)}};var m=0},{}],10:[function(h,l,d){l.exports="3.0.7"},{}]},{},[8])(8)});

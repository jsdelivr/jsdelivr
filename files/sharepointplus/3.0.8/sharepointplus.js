    ...
    */
    ...
    /**
      ...
      @param {Object} [setup] Options (see below)
        ...
        @param {Boolean} [setup.whereCAML=false] If you want to pass a WHERE clause that is with CAML Syntax only instead of SQL-like syntax (look at the examples below to know how to use it) -- see $SP().parse() for more info

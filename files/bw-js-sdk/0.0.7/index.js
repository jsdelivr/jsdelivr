...
var BrightWork = (function () {
    ...
    BrightWork.query = function query() {
    ...
    BrightWork.prototype.initModels = function initModels(settings) {
        var _this2 = this;
...
},{"../core/createError":7,"./../core/settle":10,"./../helpers/btoa":14,"./../helpers/buildURL":15,"./../helpers/cookies":17,"./../helpers/isURLSameOrigin":19,"./../helpers/parseHeaders":21,"./../utils":23,"_process":25}],4:[function(require,module,exports){
'use strict';
...
},{"../adapters/http":3,"../adapters/xhr":3,"./../utils":23,"./transformData":11,"_process":25}],9:[function(require,module,exports){
'use strict';
...
var Query = (function () {
    ...
    Query.prototype.equalTo = function equalTo(field, value) {
    ...
    Query.prototype.notEqualTo = function notEqualTo(field, value) {
        this._where.push(_lodash2['default'].set({}, [field, '!'], value));
        return this;
    };
    ...
    Query.prototype.lessThan = function lessThan(field, value) {
        this._where.push(_lodash2['default'].set({}, [field, '<'], value));
        return this;
    };
    ...
    Query.prototype.lessThanOrEqual = function lessThanOrEqual(field, value) {
        this._where.push(_lodash2['default'].set({}, [field, '<='], value));
        return this;
    };
    ...
    Query.prototype.greaterThan = function greaterThan(field, value) {
        this._where.push(_lodash2['default'].set({}, [field, '>'], value));
        return this;
    };
    ...
    Query.prototype.greaterThanOrEqual = function greaterThanOrEqual(field, value) {
        this._where.push(_lodash2['default'].set({}, [field, '>='], value));
        return this;
    };
    ...
    Query.prototype.like = function like(field, value) {
        // % wildcard
    ...
    Query.prototype.contains = function contains(field, value) {
    ...
    Query.prototype.startsWith = function startsWith(field, value) {
    ...
    Query.prototype.endsWith = function endsWith(field, value) {
    ...
    Query.prototype.oneOf = function oneOf(field, values) {
    ...
    Query.prototype.notOneOf = function notOneOf(field, values) {
        this._where.push(_lodash2['default'].set({}, [field, '!'], values));
        return this;
    };
    ...
    Query.prototype.limit = function limit(num) {
        this._limit = num;
        return this;
    };
    ...
    Query.prototype.skip = function skip(num) {
        this._skip = num;
        return this;
    };
    ...
    Query.prototype.toCriteria = function toCriteria() {
        var criteria = {};
...
var Repository = (function () {
    ...
    Repository.prototype.find = function find(query) {

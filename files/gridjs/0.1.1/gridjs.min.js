...
")";f.textAlign=r;f.textBaseline=n;f.font=[p,w,y,g,k].join(" ");f.fillText(c,a,b);!0!==this.holdon&&(this.imageData=f.getImageData(0,0,this.width,this.height),this.pixel=this.pixel.G!==m?x(this.imageData):v(this.imageData));return this}}})(window,document);
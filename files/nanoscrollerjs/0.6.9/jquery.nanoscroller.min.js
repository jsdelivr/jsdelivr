...
a.scroll).unbind("keydown",a.keydown).unbind("keyup",a.keyup)};c.prototype.generate=function(){var a,b,c,g,e;c=this.options;g=c.paneClass;e=c.sliderClass;a=c.contentClass;!this.$el.find(""+g).length&&!this.$el.find(""+e).length&&this.$el.append('<div class="'+g+'"><div class="'+e+'" /></div>');this.content=this.$el.children("."+a);this.content.attr("tabindex",0);this.slider=this.$el.find("."+e);this.pane=this.$el.find("."+g);h&&(b={right:-h},this.$el.addClass("has-scrollbar"));c.iOSNativeScrolling&&
(null==b&&(b={}),b.WebkitOverflowScrolling="touch");null!=b&&this.content.css(b);return this};c.prototype.restore=function(){this.stopped=!1;this.pane.show();return this.addEvents()};c.prototype.reset=function(){var a,b,c,g,e,d,f;this.$el.find("."+this.options.paneClass).length||this.generate().stop();this.stopped&&this.restore();a=this.content[0];c=a.style;g=c.overflowY;k&&this.content.css({height:this.content.height()});b=a.scrollHeight+h;d=this.pane.outerHeight();f=parseInt(this.pane.css("top"),
10);e=parseInt(this.pane.css("bottom"),10);e=d+f+e;f=Math.round(e/b*e);f<this.options.sliderMinHeight?f=this.options.sliderMinHeight:null!=this.options.sliderMaxHeight&&f>this.options.sliderMaxHeight&&(f=this.options.sliderMaxHeight);"scroll"===g&&"scroll"!==c.overflowX&&(f+=h);this.maxSliderTop=e-f;this.contentHeight=b;this.paneHeight=d;this.paneOuterHeight=e;this.sliderHeight=f;this.slider.height(f);this.events.scroll();this.pane.show();this.isActive=!0;this.pane.outerHeight(!0)>=a.scrollHeight&&

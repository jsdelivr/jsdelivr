/*! text-formatjs | 0.2.1 | 2017-02-02 */
            ...
            if (!isExponent && text.substr(position, _symbols.getInfinity().length).search(_symbols.getInfinity()) > -1) {
                ...
                for (;position < text.length; ++position) {
                    ...
                    if (digit == 0) {
                        ...
                        if (_subparse(text, pos, "", symbols.getMinusSign(), exponentDigits, true, stat) && exponentDigits.fitsIntoLong(stat[_STATUS_POSITIVE], true)) {
                            position = pos.index;

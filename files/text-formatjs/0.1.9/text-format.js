/*! text-formatjs | 0.1.9 | 2017-01-25 */
(function() {
    var global = this;
...
(function() {
    ...
    function DecimalFormat(pattern, symbols) {
            ...
            for (var j = 1; j >= 0; --j) {
                ...
                for (i = digitCount; i > 0; --i) {
                    if (i != digitCount && _this.isGroupingUsed() && _groupingSize != 0 && i % _groupingSize == 0) {
                        result += localized ? symbols.getGroupingSeparator() : _PATTERN_GROUPING_SEPARATOR;
                    }
                    result += i <= _this.getMinimumIntegerDigits() ? localized ? symbols.getZeroDigit() : _PATTERN_ZERO_DIGIT : localized ? symbols.getDigit() : _PATTERN_DIGIT;
                }
                if (_this.getMaximumFractionDigits() > 0 || _decimalSeparatorAlwaysShown) result += localized ? symbols.getDecimalSeparator() : _PATTERN_DECIMAL_SEPARATOR;
                for (i = 0; i < _this.getMaximumFractionDigits(); ++i) {
                    if (i < _this.getMinimumFractionDigits()) {
                        result += localized ? symbols.getZeroDigit() : _PATTERN_ZERO_DIGIT;
                    } else {
                        result += localized ? symbols.getDigit() : _PATTERN_DIGIT;
                    }
                }
                if (_useExponentialNotation) {
                    result += localized ? symbols.getExponentSeparator() : _PATTERN_EXPONENT;
                    for (i = 0; i < _minExponentDigits; ++i) result += localized ? symbols.getZeroDigit() : _PATTERN_ZERO_DIGIT;
                }
                if (j == 1) {
                    ...
                    _negativeSuffix === _positiveSuffix || _negSuffixPattern != null && _negSuffixPattern === _posSuffixPattern) {
                        ...
                        _negativePrefix === symbols.getMinusSign() + _positivePrefix) break;
                    }
                    result += localized ? symbols.getPatternSeparator() : _PATTERN_SEPARATOR;
                } else {
        ...
        var _subformat = function(result, isNegative, isInteger, maxIntDigits, minIntDigits, maxFraDigits, minFraDigits) {
            ...
            if (!isExponent && text.substr(position, _symbols.getInfinity().length).search(_symbols.getInfinity()) > -1) {
                ...
                for (;position < text.length; ++position) {
                    ...
                    if (digit == 0) {
                        ...
                        if (_subparse(text, pos, "", symbols.getMinusSign(), exponentDigits, true, stat) && exponentDigits.fitsIntoLong(stat[STATUS_POSITIVE], true)) {
                            position = pos.index;
        ...
        this.format = function(number, toAppendTo) {
            ...
            return _subformat(result, isNegative, false, maxIntDigits, minIntDigits, maxFraDigits, minFraDigits);
        };
    ...
    DecimalFormat.prototype.equals = function(other) {
        if (!other) return false;
        if (!global.NumberFormat.prototype.equals.apply(this, [ other ])) return false;
...
(function() {
    ...
    CalendarHelper.computeDayOfYear = function(date) {
        ...
        return (end.getTime() - start.getTime()) / (24 * 60 * 60 * 1e3);
    };
...
(function() {
    ...
    DateFormat.getTimeInstance = function(style, locale) {
        return _get(typeof style != "undefined" ? style : DateFormat.DEFAULT, 0, 1, locale || global.Locale.getDefault());
    };
    DateFormat.getDateInstance = function(style, locale) {
        return _get(0, typeof style != "undefined" ? style : DateFormat.DEFAULT, 2, locale || global.Locale.getDefault());
    };
    DateFormat.getDateTimeInstance = function(dateStyle, timeStyle, locale) {
        return _get(typeof timeStyle != "undefined" ? timeStyle : DateFormat.DEFAULT, typeof dateStyle != "undefined" ? dateStyle : DateFormat.DEFAULT, 3, locale || global.Locale.getDefault());
    };
...
(function() {
    ...
    function SimpleDateFormat() {
        ...
        var _subFormat = function(patternCharIndex, count, buffer, useDateFormatSymbols) {
            ...
            switch (patternCharIndex) {
              case global.DateFormatSymbols.PATTERN_ERA:
                // 'G'
              ...
              case global.DateFormatSymbols.PATTERN_WEEK_YEAR:
              // 'Y'
                case global.DateFormatSymbols.PATTERN_YEAR:
                // 'y'
              ...
              case global.DateFormatSymbols.PATTERN_MONTH:
                // 'M'
                if (useDateFormatSymbols) {
                    var months;
                    if (count >= 4) {
              ...
              case global.DateFormatSymbols.PATTERN_HOUR_OF_DAY1:
              ...
              case global.DateFormatSymbols.PATTERN_DAY_OF_WEEK:
                // 'E'
                if (useDateFormatSymbols) {
                    var weekdays;
                    if (count >= 4) {
              ...
              case global.DateFormatSymbols.PATTERN_AM_PM:
                // 'a'
                if (useDateFormatSymbols) {
              ...
              case global.DateFormatSymbols.PATTERN_HOUR1:
              ...
              // TODO: Use time zones
                /*case global.DateFormatSymbols.PATTERN_ZONE_NAME: // 'z'
                    ...
                    break;*/
                case global.DateFormatSymbols.PATTERN_ZONE_VALUE:
                // 'Z' ("-/+hhmm" form)
              ...
              case global.DateFormatSymbols.PATTERN_ISO_ZONE:
                // 'X'
                value = -CalendarHelper.getField(_date, 15);
                if (value == 0) {
                    buffer += "Z";
        ...
        var _subParse = function(text, start, patternCharIndex, count, obeyCount, ambiguousYear, origPos, useFollowingMinusSignAsDelimiter, date) {
            ...
            parsing: {
                ...
                // the parsed value.
                if (patternCharIndex == global.DateFormatSymbols.PATTERN_HOUR_OF_DAY1 || patternCharIndex == global.DateFormatSymbols.PATTERN_HOUR1 || patternCharIndex == global.DateFormatSymbols.PATTERN_MONTH && count <= 2 || patternCharIndex == global.DateFormatSymbols.PATTERN_YEAR || patternCharIndex == global.DateFormatSymbols.PATTERN_WEEK_YEAR) {
                ...
                switch (patternCharIndex) {
                  ...
                  case global.DateFormatSymbols.PATTERN_ZONE_NAME:
                  // 'z'
                    case global.DateFormatSymbols.PATTERN_ZONE_VALUE:
                    // 'Z'
                    {
        ...
        var _init = function() {
            if (arguments.length > 0 && arguments.length <= 2) {
                ...
                var timeStyle = arguments.length > 0 && typeof arguments[0] != "undefined" ? arguments[0] : global.DateFormat.SHORT;
                var dateStyle = arguments.length > 0 && typeof arguments[1] != "undefined" ? arguments[1] : global.DateFormat.SHORT;
                var loc = arguments.length > 0 && typeof arguments[2] != "undefined" ? arguments[2] : global.Locale.getDefault();
                _locale = loc;
    ...
    var _PATTERN_INDEX_TO_DATE_FORMAT_FIELD = [ global.DateFormat.ERA_FIELD, global.DateFormat.YEAR_FIELD, global.DateFormat.MONTH_FIELD, global.DateFormat.DATE_FIELD, global.DateFormat.HOUR_OF_DAY1_FIELD, global.DateFormat.HOUR_OF_DAY0_FIELD, global.DateFormat.MINUTE_FIELD, global.DateFormat.SECOND_FIELD, global.DateFormat.MILLISECOND_FIELD, global.DateFormat.DAY_OF_WEEK_FIELD, global.DateFormat.DAY_OF_YEAR_FIELD, global.DateFormat.DAY_OF_WEEK_IN_MONTH_FIELD, global.DateFormat.WEEK_OF_YEAR_FIELD, global.DateFormat.WEEK_OF_MONTH_FIELD, global.DateFormat.AM_PM_FIELD, global.DateFormat.HOUR1_FIELD, global.DateFormat.HOUR0_FIELD, global.DateFormat.TIMEZONE_FIELD, global.DateFormat.TIMEZONE_FIELD, global.DateFormat.YEAR_FIELD, global.DateFormat.DAY_OF_WEEK_FIELD, global.DateFormat.TIMEZONE_FIELD ];
    // Maps from DateFormatSymbols index to Field constant
    var _PATTERN_INDEX_TO_DATE_FORMAT_FIELD_ID = [ global.DateFormat.Field.ERA, global.DateFormat.Field.YEAR, global.DateFormat.Field.MONTH, global.DateFormat.Field.DAY_OF_MONTH, global.DateFormat.Field.HOUR_OF_DAY1, global.DateFormat.Field.HOUR_OF_DAY0, global.DateFormat.Field.MINUTE, global.DateFormat.Field.SECOND, global.DateFormat.Field.MILLISECOND, global.DateFormat.Field.DAY_OF_WEEK, global.DateFormat.Field.DAY_OF_YEAR, global.DateFormat.Field.DAY_OF_WEEK_IN_MONTH, global.DateFormat.Field.WEEK_OF_YEAR, global.DateFormat.Field.WEEK_OF_MONTH, global.DateFormat.Field.AM_PM, global.DateFormat.Field.HOUR1, global.DateFormat.Field.HOUR0, global.DateFormat.Field.TIME_ZONE, global.DateFormat.Field.TIME_ZONE, global.DateFormat.Field.YEAR, global.DateFormat.Field.DAY_OF_WEEK, global.DateFormat.Field.TIME_ZONE ];
    ...
    SimpleDateFormat.prototype.equals = function(that) {
        if (!global.DateFormat.equals.apply(this, [ that ])) return false;
        // super does class check

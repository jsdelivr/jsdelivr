...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e},_createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var u=t[r];u.enumerable=u.enumerable||!1,u.configurable=!0,"value"in u&&(u.writable=!0),Object.defineProperty(e,u.key,u)}}return function(t,r,u){return r&&e(t.prototype,r),u&&e(t,u),t}}();require("babel-polyfill");var _superagent=require("superagent"),_superagent2=_interopRequireDefault(_superagent),_superagentPrefix=require("superagent-prefix"),_superagentPrefix2=_interopRequireDefault(_superagentPrefix),_Defaults=require("./Defaults"),_Defaults2=_interopRequireDefault(_Defaults),Particle=function(){function e(){var t=arguments.length<=0||void 0===arguments[0]?_Defaults2["default"]:arguments[0];_classCallCheck(this,e),Object.assign(this,t),this.prefix=(0,_superagentPrefix2["default"])(this.baseUrl)}return _createClass(e,[{key:"login",value:function(e){var t=e.username,r=e.password,u=e.tokenDuration,i=void 0===u?this.tokenDuration:u;return this.request({uri:"/oauth/token",form:{username:t,password:r,grant_type:"password",client_id:this.clientId,client_secret:this.clientSecret,expires_in:i},method:"post"})}},{key:"createUser",value:function(e){var t=e.username,r=e.password;return this.post("/v1/users",{username:t,password:r})}},{key:"removeAccessToken",value:function(e){var t=e.username,r=e.password,u=e.token;return this["delete"]("/v1/access_tokens/"+u,{access_token:u},{username:t,password:r})}},{key:"listAccessTokens",value:function(e){var t=e.username,r=e.password;return this.get("/v1/access_tokens",{username:t,password:r})}},{key:"listDevices",value:function(e){var t=e.auth;return this.get("/v1/devices",t)}},{key:"getDevice",value:function(e){var t=e.deviceId,r=e.auth;return this.get("/v1/devices/"+t,r)}},{key:"claimDevice",value:function(e){var t=e.deviceId,r=e.auth;return this.post("/v1/devices",{id:t},r)}},{key:"removeDevice",value:function(e){var t=e.deviceId,r=e.auth;return this["delete"]("/v1/devices/"+t,null,r)}},{key:"renameDevice",value:function(e){var t=e.deviceId,r=e.name,u=e.auth;return this.put("/v1/devices/"+t,{name:r},u)}},{key:"getClaimCode",value:function(e){var t=e.auth,r=e.iccid,u=void 0===r?void 0:r;return this.post("/v1/device_claims",{iccid:u},t)}},{key:"validatePromoCode",value:function(e){var t=e.auth,r=e.promoCode;return this.get("/v1/promo_code/"+r,t)}},{key:"changeProduct",value:function(e){var t=e.deviceId,r=e.productId,u=e.shouldUpdate,i=e.auth;return this.put("/v1/devices/"+t,{product_id:r,update_after_claim:u||!1},i)}},{key:"getVariable",value:function(e){var t=e.deviceId,r=e.name,u=e.auth;return this.get("/v1/devices/"+t+"/"+r,u)}},{key:"signalDevice",value:function(e){var t=e.deviceId,r=e.signal,u=e.auth;return this.put("/v1/devices/"+t,{signal:r?1:0},u)}},{key:"flashDevice",value:function(e){var t=e.deviceId,r=e.files,u=e.targetVersion,i=e.auth,a={};return u?a.build_target_version=u:a.latest=!0,this.request({uri:"/v1/devices/"+t,files:r,auth:i,form:a,method:"put"})}},{key:"flashTinker",value:function(e){var t=e.deviceId,r=e.auth;return this.put("/v1/devices/"+t,{app:"tinker"},r)}},{key:"compileCode",value:function(e){var t=e.files,r=e.platformId,u=e.targetVersion,i=e.auth,a={platform_id:r};return u?a.build_target_version=u:a.latest=!0,this.request({uri:"/v1/binaries",files:t,auth:i,form:a,method:"post"})}},{key:"sendPublicKey",value:function(e){var t=e.deviceId,r=e.key,u=e.algorithm,i=e.auth;return this.post("/v1/provisioning/"+t,{deviceID:t,publicKey:"string"==typeof r?r:r.toString(),filename:"particle-api",order:"manual_"+Date.now(),algorithm:u||"rsa"},i)}},{key:"callFunction",value:function(e){var t=e.deviceId,r=e.name,u=e.argument,i=e.auth;return this.post("/v1/devices/"+t+"/"+r,{args:u},i)}},{key:"getEventStream",value:function(e){var t=e.deviceId,r=e.name,u=e.auth,i=void 0;return i=t?"mine"===t.toLowerCase()?"/v1/devices/events":"/v1/devices/"+t+"/events":"/v1/events",r&&(i+="/"+r),this.get(i,u)}},{key:"publishEvent",value:function(e){var t=e.name,r=e.data,u=e.isPrivate,i=e.auth;return this.post("/v1/devices/events",{name:t,data:r,"private":u},i)}},{key:"createWebhook",value:function(e){var t=e.deviceId,r=e.name,u=e.url,i=e.requestType,a=e.headers,n=e.json,o=e.query,s=e.rejectUnauthorized,v=e.webhookAuth,c=e.form,d=e.auth,l={event:r,url:u,requestType:i,headers:a,json:n,query:o,rejectUnauthorized:s,auth:v,form:c};return"mine"===t?l.mydevices=!0:l.deviceid=t,this.post("/v1/webhooks",l,d)}},{key:"deleteWebhook",value:function(e){var t=e.hookId,r=e.auth;return this["delete"]("/v1/webhooks/"+t,null,r)}},{key:"listWebhooks",value:function(e){var t=e.auth;return this.get("/v1/webhooks",t)}},{key:"getUserInfo",value:function(e){var t=e.auth;return this.get("/v1/user",t)}},{key:"setUserInfo",value:function(e){var t=e.stripeToken,r=e.auth;return this.put("/v1/user",{stripe_token:t},r)}},{key:"checkSIM",value:function(e){var t=e.iccid,r=e.auth;return this.head("/v1/sims/"+t,r)}},{key:"activateSIM",value:function(e){var t=e.iccid,r=e.countryCode,u=e.promoCode,i=e.auth;return this.put("/v1/sims/"+t,{country:r,promo_code:u,action:"activate"},i)}},{key:"listBuildTargets",value:function(e){var t=e.auth,r=e.onlyFeatured,u=void 0===r?void 0:r,i=void 0;return void 0!==u&&(i={featured:!!u}),this.get("/v1/build_targets",t,i)}},{key:"get",value:function(e,t){var r=arguments.length<=2||void 0===arguments[2]?void 0:arguments[2];return this.request({uri:e,auth:t,method:"get",query:r})}},{key:"head",value:function(e,t){return this.request({uri:e,auth:t,method:"head"})}},{key:"post",value:function(e,t,r){return this.request({uri:e,data:t,auth:r,method:"post"})}},{key:"put",value:function(e,t,r){return this.request({uri:e,data:t,auth:r,method:"put"})}},{key:"delete",value:function(e,t,r){return this.request({uri:e,data:t,auth:r,method:"delete"})}},{key:"request",value:function(e){var t=this,r=e.uri,u=e.method,i=e.data,a=void 0===i?void 0:i,n=e.auth,o=e.query,s=void 0===o?void 0:o,v=e.form,c=void 0===v?void 0:v,d=e.files,l=void 0===d?void 0:d;return new Promise(function(e,i){var o=(0,_superagent2["default"])(u,r);o.use(t.prefix),t.headers(o,n),s&&o.query(s),l?(Object.keys(l).forEach(function(e,t){o.attach("file"+(t+1),l[e],e)}),c&&Object.keys(c).forEach(function(e){o.field(e,c[e])})):c?(o.type("form"),o.send(c)):a&&o.send(a),o.end(function(t,u){var a=u&&u.body;if(t){var n=t.status,o=(n?"HTTP error":"Network error")+" "+n+" from "+r;a&&a.error_description&&(o+=" - "+a.error_description),i({statusCode:n,errorDescription:o,error:t})}else e({body:a,statusCode:u.statusCode})})})}},{key:"headers",value:function(e,t){t&&("object"===("undefined"==typeof t?"undefined":_typeof(t))?e.auth(t.username,t.password):e.set({Authorization:"Bearer "+t}))}}]),e}();exports["default"]=Particle,module.exports=exports["default"];
},{"./Defaults":1,"babel-polyfill":3,"superagent":194,"superagent-prefix":193}],3:[function(require,module,exports){
(function (global){
...
},{"_process":192}],5:[function(require,module,exports){

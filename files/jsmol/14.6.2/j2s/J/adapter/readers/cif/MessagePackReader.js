...
Clazz.load (null, "J.adapter.readers.cif.MessagePackReader", ["java.lang.Boolean", "$.Float", "$.Long", "java.util.Hashtable", "JU.BC", "$.SB"], function () {
...
switch (type) {
case 1:
return J.adapter.readers.cif.MessagePackReader.getFloats (b, n, 1);
case 2:
case 3:
case 4:
return J.adapter.readers.cif.MessagePackReader.getInts (b, n);
case 5:
return J.adapter.readers.cif.MessagePackReader.rldecode32ToStr (b);
case 6:
return J.adapter.readers.cif.MessagePackReader.rldecode32ToChar (b, n);
case 7:
return J.adapter.readers.cif.MessagePackReader.rldecode32 (b, n);
case 8:
return J.adapter.readers.cif.MessagePackReader.rldecode32Delta (b, n);
case 9:
return J.adapter.readers.cif.MessagePackReader.rldecodef (b, n, param);
case 10:
return J.adapter.readers.cif.MessagePackReader.unpack16Deltaf (b, n, param);
case 11:
return J.adapter.readers.cif.MessagePackReader.getFloats (b, n, param);
case 12:
case 13:
return J.adapter.readers.cif.MessagePackReader.unpackf (b, 14 - type, n, param);
case 14:
case 15:
return J.adapter.readers.cif.MessagePackReader.unpack (b, 16 - type, n);
default:

...
ej.FileExplorer.Locale["es-ES"] = {
    ...
    NewFolderAlert: "Por favor, introduzca el nuevo nombre de carpeta,",
    ...
    ContextMenuPaste: "Pegar",
    ContextMenuGetinfo: "Conseguir información",
    ...
    NoToAllButton: "No a todo",
    YesButton: "Sí",
    NoButton: "No",
    SkipButton: "Omitir",
    Grid: "Vista en cuadrícula",
    Tile: "vista del azulejo",
...
ej.PivotClient.Locale["es-ES"] = {
    ...
    Condition: "Condición",
    PreserveHierarchy: "Preservar la jerarquía",
...
ej.ReportViewer.Locale["es-ES"] = {
    toolbar: {
        ...
        exportformat: {
            headerText: "Exportar",
            contentText: "Seleccione el formato del archivo exportado.",
            Pdf: "PDF",
            Excel: "Sobresalir",
            Word: "Palabra",
            Html: "html"
        ...
        printLayout: {
            ...
            contentText: "Cambiar entre los modos de diseño de impresión y normales."
        },
        pageIndex: {
            headerText: "Número de página",
            contentText: "número de página actual para ver."
...
ej.RTE.Locale["es-ES"] = {
    ...
    unorderedList: "Insertar lista desordenada",
    ...
    removeLink: "Retire hipervínculo",
    image: "Insertar imagen",
    video: "Insertar vídeo",
    editTable: "Editar propiedades de la tabla",
    embedVideo: "Pega el código de inserción por debajo",
    viewHtml: "Ver HTML",
    ...
    style: "estilos",
    deleteAlert: "¿Está seguro de que desea borrar todos los contenidos?",
    ...
    imageBorder: "imagen de la frontera",
    imageStyle: "Estilo",
    linkText: "Texto",
    linkToolTip: "Tooltip",
    html5Support: "Este icono de la herramienta sólo disponible en HTML5 navegadores compatibles",
    linkOpenInNewWindow: "Abrir el enlace en una nueva ventana",
    tableColumns: "No. de Columnas",
    tableRows: "Filas No.of",
    tableWidth: "Anchura",
    tableHeight: "Altura",
    ...
    addColumnLeft: "Añadir columna de la izquierda",

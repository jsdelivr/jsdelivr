...
ej.RecurrenceEditor.Locale["zh-CN"] = {
    Repeat: "重复",
    Never: "决不",
    Daily: "日常",
    Weekly: "每周",
...
ej.Schedule.Locale["zh-CN"] = {
    ...
    CreateAppointmentTitle: "创建预约",
    RecurrenceEditTitle: "编辑重复预约",
    RecurrenceEditMessage: "您想如何更改系列预约？",
    RecurrenceEditOnly: "只有这个约会",
    RecurrenceEditSeries: "整个系列",
    PreviousAppointment: "上一个预约",
    NextAppointment: "下一个预约",
    AppointmentSubject: "学科",
    StartTime: "开始时间",
    EndTime: "时间结束",
    AllDay: "整天",
    StartTimeZone: "启动TimeZone",
    EndTimeZone: "结束时区",
    Today: "今天",
    Recurrence: "重复",
    Done: "完成",
    ...
    Gotodate: "转到日期",
    Resources: "资源",
    RecurrenceDeleteTitle: "删除重复预约",
    Location: "位置",
    Priority: "优先",
    RecurrenceAlert: "警报",
    NoTitle: "无题",
    OverFlowAppCount: "更多约会",
    AppointmentIndicator: "点击查看更多约会",
    WrongPattern: "重复发生模式无效",
    CreateError: "约会的持续时间必须短于其发生的频率。 缩短持续时间，或更改“预约复现”对话框中的重复发生模式。",
    DragResizeError: "如果跳过同一约会的后续事件，则无法重新计划重复约会的发生。",
    StartEndError: "结束时间应大于开始时间",
    MouseOverDeleteTitle: "删除预约",
    DeleteConfirmation: "您确定要删除此约会吗？",
    Time: "时间",
    EmptyResultText: "没有建议",

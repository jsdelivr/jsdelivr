...
ej.PivotClient.Locale["fr-FR"] = {
    ...
    Condition: "Condition",
    PreserveHierarchy: "Préserver la hiérarchie",
    Ascending: "Ordre croissant",
    Descending: "En ordre décroissant",
    Enable: "Activer",
    Disable: "Désactiver",
    and: "Et",
    Line: "Ligne",
    ...
    Column: "Colonne",
    Area: "Région",
    SplineArea: "Rainurage Salon",
    StepLine: "étape ligne",
    StepArea: "étape Salon",
    Pie: "Tarte",
    Bar: "Bar",
    StackingArea: "L'empilage Salon",
...
ej.PivotPager.Locale["fr-FR"] = {
    SeriesPage: "Page de la série",
    CategoricalPage: "catégorique La page",
    Error: "Error",
    OK: "OK",
    Close: "Fermer",
...
ej.Kanban.Locale["fr-FR"] = {
    EmptyCard: "Aucune carte à afficher",
    SaveButton: "sauvegarder",
    CancelButton: "Annuler",
    EditFormTitle: "Les détails de ",
    AddFormTitle: "Ajouter une nouvelle carte",
    SwimlaneCaptionFormat: "- {{:count}}{{if count == 1 }} article {{else}} articles {{/if}}",

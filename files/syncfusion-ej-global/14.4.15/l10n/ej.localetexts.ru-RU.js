...
ej.RecurrenceEditor.Locale["ru-RU"] = {
    Repeat: "Повторение",
    Never: "Никогда",
    Daily: "Ежедневно",
    Weekly: "еженедельно",
    ...
    Every: "каждый",
    RecurrenceDay: "дней",
    RecurrenceWeek: "Недели",
    RecurrenceMonth: "Месяцы",
    RecurrenceYear: "лет",
    RepeatOn: "Повторите",
    ...
    After: "После",
    On: "На",
    Occurrence: "Появления"
};
ej.Schedule.Locale["ru-RU"] = {
    ReminderWindowTitle: "окно Напоминание",
    CreateAppointmentTitle: "Создание Назначение",
    RecurrenceEditTitle: "Правка Повторить Назначение",
    ...
    NextAppointment: "Следующее назначение",
    AppointmentSubject: "Предмет",
    StartTime: "Время начала",
    EndTime: "Время окончания",
    AllDay: "Весь день",
    StartTimeZone: "Начало TimeZone",
    EndTimeZone: "Конец часового пояса",
    Today: "Cегодня",
    ...
    Last: "Последний",
    WeekDay: "будний день",
    WeekEndDay: "День выходные",
    Subject: "Предмет",
    Categorize: "категории",
    DueIn: "Из-В",
    DismissAll: "Отклонить все",
    Dismiss: "отклонять",
    OpenItem: "Открытый Пункт",
    Snooze: "вздремнуть",
    Day: "День",
    Week: "Неделю",
    ...
    EventBeginsin: "Назначение начинается",
    Editevent: "Изменить назначение",
    Editseries: "Редактирование серии",
    Times: "раз",
    Until: "до",
    ...
    Priority: "приоритет",
    RecurrenceAlert: "бдительный",
    NoTitle: "Без заголовка",
    OverFlowAppCount: "больше назначений",
    AppointmentIndicator: "Нажмите для большего количества назначений",
    WrongPattern: "Шаблон повторения не является действительным",
    CreateError: "Продолжительность назначения должна быть короче, чем то, как часто это происходит. Сократить продолжительность, или изменить шаблон повторения в диалоговом окне Назначение Recurrence.",
    DragResizeError: "Не удается перенести возникновение повторяющегося назначения, если он перепрыгивает через более позднем наступлении одного и того же назначения.",
    StartEndError: "Конечное время должно быть больше, чем время начала",
    MouseOverDeleteTitle: "Удалить встречу",
    DeleteConfirmation: "Вы уверены, что хотите удалить это назначение?",
    Time: "Время",
    EmptyResultText: "Нет предложений",

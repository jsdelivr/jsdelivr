    ...
    **/
    _init: function() {
        ...
        **/
        ...
        if (!Env) {
            Y.Env = {
                core: ["get","features","intl-base","yui-log","yui-later","loader-base","loader-rollup","loader-yui3","aui-loader","aui-base-core"],
...
}, '2.0.0pr2', {"requires": ["get", "features"]});
...
Y.mix(YUI.Env.aliases, {
    ...
    "aui-button": ["button","button-group","button-plugin","aui-button-core"],
...
YUI.add('yui', function (Y, NAME) {}, '2.0.0pr2', {
    "use": [
        "yui-base",
        "get",
        "features",
...
YUI.add('aui', function (A, NAME) {}, '2.0.0pr2');

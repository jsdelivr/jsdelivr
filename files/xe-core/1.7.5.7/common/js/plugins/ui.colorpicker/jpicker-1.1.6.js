        ...
        var $this = this, // private properties and methods
            ...
            function(e)
            {
              ...
              switch (e.target)
              {
                ...
                case bindedHex && bindedHex.get(0):
				  if(ColorMethods.isHex(bindedHex.val())){
                    hex.val(bindedHex.val());
                    color.val('hex', bindedHex.val() != '' ? bindedHex.val() : null, e.target);
				  }else{
				    color.val('hex', null, e.target);
				  }
                  break;
          ...
          colorChanged =
            function(ui, context)
            {
              ...
              if (bindedHex && context != bindedHex.get(0) && context != hex.get(0)) bindedHex.val(all != null ? '#' + all.hex : 'transparent');
      ...
      return this.each(
        function()
        {
          ...
          if ($($this).get(0).nodeName.toLowerCase() == 'input') // Add color picker icon if binding to an input element and bind the events to the input
          {
            ...
            if($($this).val()=='' || $($this).val() == 'transparent')
            {
      ...
      window:
        {
          ...
          effects:
          {
            ...
            speed:
            {
              show: 0, /* duration of "show" effect. Acceptable values are "fast", "slow", or time in ms */
              hide: 0 /* duration of "hide" effect. Acceptable values are "fast", "slow", or time in ms */
            }
          },
          position:
          {

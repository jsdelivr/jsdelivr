...
function doDeleteProfileImage(member_srl){if(!member_srl){return}if(!confirm(xe.lang.deleteProfileImage)){return false}exec_xml("member","procMemberDeleteProfileImage",{member_srl:member_srl},function(){jQuery("#profile_imagetag").remove()},["error","message"])}function doDeleteImageName(member_srl){if(!member_srl){return}if(!confirm(xe.lang.deleteImageName)){return false}exec_xml("member","procMemberDeleteImageName",{member_srl:member_srl},function(){jQuery("#image_nametag").remove()},["error","message"])}function doDeleteImageMark(member_srl){if(!member_srl){return}if(!confirm(xe.lang.deleteImageMark)){return false}exec_xml("member","procMemberDeleteImageMark",{member_srl:member_srl},function(){jQuery("#image_marktag").remove()},["error","message"])}
/* 스크랩 삭제 !*/

...
There are no bandwidth limits or premium features and its completely free to use by anybody.  HTTP, HTTPS, and [SPDY](http://caniuse.com/spdy) v[3.1](http://blog.cloudflare.com/staying-up-to-date-with-the-latest-protocols-spdy-3-1) protocals are available.

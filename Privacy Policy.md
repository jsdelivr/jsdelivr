...
2. **processing:** means any operation or actions performed on personal data; for example collection, recording, organisation, structuring, storing, altering, deleting or otherwise using personal data;
...
3. We will also retain non-aggregated Usage Data for internal analysis purposes, for example to detect abuse of our Services. Non-aggregated Usage Data is retained for a shorter period of time, until it is analysed and deleted, except when this data is used to strengthen the security or to improve the functionality of our Service, or we are legally obligated to retain this data for longer time periods.
...
2. In certain circumstances, you have the right:
   ...
   6. You have the right to data portability for the information you provide tous. You can request to obtain a copy of your personal data in a commonly used electronic format so that you can manage and move it.
